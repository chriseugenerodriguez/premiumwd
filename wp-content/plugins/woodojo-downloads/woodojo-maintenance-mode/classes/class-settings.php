...
/**
 * WooDojo Maintenance Mode Settings Class
 *
 * @package WordPress
 * @subpackage WooDojo
...
class WooDojo_Maintenance_Mode_Settings extends WooDojo_Settings_API {
	...
	public function init_sections () {
		...
		$sections['general'] = array(
			...
			'description'	=> __( 'Determine who sees Maintenance Mode and who is allowed to view the website when logged in.', 'woodojo-maintenance-mode' )
		);

		$sections['display'] = array(
			'name' 			=> __( 'Display Settings', 'woodojo-maintenance-mode' ), 
		...
		$sections['toggles'] = array(
			'name' 			=> __( 'Toggle Settings', 'woodojo-maintenance-mode' ), 
			'description'	=> __( 'Whether or not to allow certain WordPress internal features to function when in Maintenance Mode.', 'woodojo-maintenance-mode' )
		);
	...
	public function init_fields () {
		...
		$fields['enable_feeds'] = array(
		    'name' => __( 'Allow Feeds', 'woodojo-maintenance-mode' ), 
		    'description' => __( 'Allow feeds when in Maintenance Mode.', 'woodojo-maintenance-mode' ), 
		    'type' => 'checkbox', 
		    'default' => true, 
		    'section' => 'toggles'
		);
		...
		$fields['enable_trackbacks'] = array(
		    'name' => __( 'Allow Trackbacks', 'woodojo-maintenance-mode' ), 
		    'description' => __( 'Allow trackbacks when in Maintenance Mode.', 'woodojo-maintenance-mode' ), 
		    'type' => 'checkbox', 
		    'default' => true, 
		    'section' => 'toggles'
		);
		...
		$fields['enable_xmlrpc'] = array(
		    'name' => __( 'Allow XML-RPC', 'woodojo-maintenance-mode' ), 
		    'description' => __( 'Allow XML-RPC when in Maintenance Mode.', 'woodojo-maintenance-mode' ), 
		    'type' => 'checkbox', 
		    'default' => true, 
		    'section' => 'toggles'
		);
