	...
	if ( ! class_exists( 'WC_Subscribe_To_Newsletter' ) ) {
		...
		class WC_Subscribe_To_Newsletter {
			...
			public function plugin_action_links( $links ) {
				...
				$plugin_links = array(
					'<a href="' . $setting_link . '">' . __( 'Settings', 'wc_subscribe_to_newsletter' ) . '</a>',
					'<a href="https://docs.woocommerce.com/document/newsletter-subscription/">' . __( 'Docs', 'wc_subscribe_to_newsletter' ) . '</a>',
					'<a href="http://support.woothemes.com/">' . __( 'Support', 'wc_subscribe_to_newsletter' ) . '</a>',
				);
			...
			public function add_tab( $settings_tabs ) {
				$settings_tabs[ $this->setting_tab_id ] = esc_html__( 'Newsletter', 'wc_subscribe_to_newsletter' );
