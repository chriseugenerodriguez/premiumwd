...
<?php
foreach ( $types as $key => $type ):
    $mails          = FUE::get_emails($key, array(FUE::STATUS_ACTIVE, FUE::STATUS_INACTIVE) );
    $archived_mails = FUE::get_emails($key, FUE::STATUS_ARCHIVED);
    ...
    if ( $key == 'manual' ) {
        ...
        <table class="wp-list-table widefat fixed posts <?php echo $key; ?>-table active">
                    ...
                    <tr scope="row">
                        <td class="post-title column-title">
                            ...
                            <div class="row-actions">
                                ...
                                |
                                <span class="edit edit-control">
                                    <a href="admin.php?page=followup-emails-form&step=1&id=<?php echo $email->id; ?>&step=1"><?php _e('Edit &#x25B8;', 'follow_up_emails'); ?></a>

                                    <span class="edit edit-action"><a href="admin.php?page=followup-emails-form&id=<?php echo $email->id; ?>&step=1" data-id="<?php echo $email->id; ?>"><?php _e('Name or type', 'follow_up_emails'); ?></a> |</span>
                                    <span class="edit edit-action"><a href="admin.php?page=followup-emails-form&id=<?php echo $email->id; ?>&step=2" data-id="<?php echo $email->id; ?>"><?php _e('Subject or trigger', 'follow_up_emails'); ?></a> |</span>
                                    <span class="edit edit-action"><a href="admin.php?page=followup-emails-form&id=<?php echo $email->id; ?>&step=3" data-id="<?php echo $email->id; ?>"><?php _e('Email content', 'follow_up_emails'); ?></a></span>
                                </span>
                                |
        ...
        <h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
            <a href="#<?php echo $key; ?>_active_tab" data-key="<?php echo $key; ?>" class="status-tab nav-tab nav-tab-active"><?php _e('Active Emails', 'follow_up_emails'); ?></a>
            <a href="#<?php echo $key; ?>_archived_tab" data-key="<?php echo $key; ?>" class="status-tab nav-tab"><?php _e('Archived Emails', 'follow_up_emails'); ?></a>
        </h2>

        <br/>

        <div class="email-tab <?php echo $key; ?>-tab active" id="<?php echo $key; ?>_active_tab">
            <table class="wp-list-table widefat fixed posts <?php echo $key; ?>-table active">
                        ...
                        <tr scope="row">
                            ...
                            <td>
                                ...
                                if ( $email->interval_type == 'signup' ) {
                                    ...
                                    $interval_str = sprintf( __('Send on %s'), fue_format_send_datetime( $email ) ) ;
                                }
                            ...
                            <td class="status">
                                ...
                                <?php endif; ?>
                                |
                                <small><a href="#" class="archive-email" data-id="<?php echo $email->id; ?>" data-key="<?php echo $key; ?>"><?php _e('Archive', 'follow_up_emails'); ?></a></small>
                            </td>
                        </tr>
                    <?php
                    endforeach;
        ...
        <div class="email-tab <?php echo $key; ?>-tab inactive" id="<?php echo $key; ?>_archived_tab">
            <table class="wp-list-table widefat fixed posts <?php echo $key; ?>-table inactive">
                ...
                <?php
                    ...
                    $p = 0;
                    foreach ($archived_mails as $email):
                        $p++;
                        ?>
                        <tr scope="row">
                            <td style="text-align: center; vertical-align:middle;"><span class="priority"><?php echo $p; ?></span></td>
                            ...
                            <td class="status">
                                ...
                                <br/><small><a href="#" class="unarchive" data-id="<?php echo $email->id; ?>" data-key="<?php echo $key; ?>"><?php _e('Activate', 'follow_up_emails'); ?></a></small>
                            </td>
                        </tr>
                    <?php
                    endforeach;
                            ...
                            <td class="post-title column-title">
                                ...
                                <div class="row-actions">
                                    <span class="edit edit-control">
                                        ...
                                        <span class="edit edit-action"><a href="admin.php?page=followup-emails-form&id=<?php echo $email->id; ?>&step=1&mode=quick" data-id="<?php echo $email->id; ?>"><?php _e('Name or type', 'follow_up_emails'); ?></a> |</span>
                                        <span class="edit edit-action"><a href="admin.php?page=followup-emails-form&id=<?php echo $email->id; ?>&step=2&mode=quick" data-id="<?php echo $email->id; ?>"><?php _e('Subject or trigger', 'follow_up_emails'); ?></a> |</span>
                                        <span class="edit edit-action"><a href="admin.php?page=followup-emails-form&id=<?php echo $email->id; ?>&step=3&mode=quick" data-id="<?php echo $email->id; ?>"><?php _e('Email content', 'follow_up_emails'); ?></a></span>
                                    </span>
                                    |
                                    <span class="edit"><a href="#" class="clone-email" data-id="<?php echo $email->id; ?>"><?php _e('Clone as...', 'follow_up_emails'); ?></a></span>
                                    |
        ...
        <div class="email-tab <?php echo $key; ?>-tab inactive" id="<?php echo $key; ?>_archived_tab">
            <table class="wp-list-table widefat fixed posts <?php echo $key; ?>-table">
                <thead>
                <tr>
                    <th scope="col" id="priority" class="manage-column column-type" style="width:50px;"><?php _e('Priority', 'follow_up_emails'); ?></th>
                    <th scope="col" id="type" class="manage-column column-type" style=""><?php _e('Name', 'follow_up_emails'); ?></th>
                    <th scope="col" id="amount" class="manage-column column-amount" style=""><?php _e('Interval', 'follow_up_emails'); ?></th>
                    <th scope="col" id="usage_count" class="manage-column column-usage_count" style=""><?php _e('Used', 'follow_up_emails'); ?></th>
                    <th scope="col" id="<?php echo $key; ?>_always_send"><?php _e('Always Send', 'follow_up_emails'); ?></th>
                    <?php do_action( 'fue_table_'. $key .'_head' ); ?>
                    <th scope="col" id="status" class="manage-column column-status"><?php _e('Status', 'follow_up_emails'); ?></th>
                </tr>
                </thead>
...
<script type="text/javascript">
    jQuery(window).load(function(){
        ...
        jQuery(".archive-email").live("click", function(e) {
            e.preventDefault();
        ...
        jQuery(".edit-control").live("mouseenter", function() {
            jQuery(this).parents("div.row-actions").find("span.edit-action").fadeIn();
        });

        jQuery(".edit-control").live("mouseleave", function() {
            jQuery(this).parents("div.row-actions").find("span.edit-action").fadeOut();
        });
