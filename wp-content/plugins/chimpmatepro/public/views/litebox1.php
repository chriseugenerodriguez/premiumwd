...
pointer-events: none;
  ...
  if($theme["lite_button_i"] != 'inone' && $theme["lite_button_i"] != 'idef'){
    $col = ((isset($theme["lite_button_fc"]))? $theme["lite_button_fc"] : '#fff');
     echo 'background: '.$this->getIcon($theme["lite_button_i"],30,$col).' no-repeat center;';
  }
  ?>
}
...
#wpmchimpa-main.lsoconly #wpmchimpa-newsletterform{
<?php if($scroll){?>
/*long form*/
max-height: calc(100% - 100px);
<?php } ?>
}
#wpmchimpa-main.limgonly #wpmchimpa-newsletterform{
<?php if($scroll){?>
/*long form*/
...
?>
  <div class="wpmchimpa-subs-button<?php echo (isset($theme['lite_button_i']) && $theme['lite_button_i'] != 'inone' && $theme['lite_button_i'] != 'idef')? ' subsicon' : '';?>"></div>
            ...
            echo $this->getSpin(isset($theme["lite_spinner_t"])?$theme["lite_spinner_t"]:'7','wpmchimpa-main',isset($theme["lite_spinner_c"])?$theme["lite_spinner_c"]:'#000');?></div></div>
        		</form>
