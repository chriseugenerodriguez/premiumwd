...
.wpmchimpat.signalshow .wpmchimpa-subs-button::after,
...
#wpmchimpat<?php echo $topbar_scode;?> .wpmchimpa-field{width: 100%;margin-bottom: 10px;}
...
'type' => 2,
'sig' => $this->getSpin(isset($theme["addon_spinner_t"])?$theme["addon_spinner_t"]:'8',$topid,isset($theme["addon_spinner_c"])?$theme["addon_spinner_c"]:'#000')
);
