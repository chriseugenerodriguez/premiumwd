...
<?php if(isset($this->wpmchimpa['slider_behave_movein'])){?>
.wpmchimpas-resp{
...
$form = $this->getformbyid((isset($cmeta['Slider']['form'])?$cmeta['Slider']['form'] : (isset($cmeta_cat['Slider']['form'])?$cmeta_cat['Slider']['form'] : $wpmchimpa['slider_form'])));
global $mcabtheme;
$t= (isset($mcabtheme)?$mcabtheme:(isset($cmeta['Slider']['theme'])?$cmeta['Slider']['theme'] : (isset($cmeta_cat['Slider']['theme'])?$cmeta_cat['Slider']['theme'] :$wpmchimpa['slider_theme'])));
if(!isset($form['preset']))$form['preset'] = array();
if($mcabtheme != -1)
include_once( 'slide'.$t.'.php' );
?>
