...
background-image:{{getIcon(data.theme.w1.widget_check_mark||'ch6',16,data.theme.w1.widget_check_ic||'#000')}};
}
...
-webkit-border-radius: {{data.theme.w1.widget_button_br||'3'}}px;
-moz-border-radius: {{data.theme.w1.widget_button_br||'3'}}px;
border-radius: {{data.theme.w1.widget_button_br||'3'}}px;
  ...
  <div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="8" data-lhint="Go to Additional Theme Options" style="margin:-15px">7</div>
        ...
        <div class="wpmchimpaw">
          ...
          <div>
              ...
              <div class="widget_spinner" ng-bind-html="getSpin(data.theme.w1.widget_spinner_t||'7','wpmchimpaw',data.theme.w1.widget_spinner_c||'#000')"></div>
            </div>
          </div>
  </div>
</div>
