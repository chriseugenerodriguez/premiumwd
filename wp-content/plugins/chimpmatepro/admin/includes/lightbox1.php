...
max-width: 850px;
min-height: 350px;
background: {{data.theme.l1.lite_bg_c || '#fff'}};
...
background-image:{{getIcon(data.theme.l1.lite_check_mark||'ch6',16,data.theme.l1.lite_check_ic||'#000')}};
}
...
-webkit-border-radius: {{data.theme.l1.lite_button_br||'3'}}px;
-moz-border-radius: {{data.theme.l1.lite_button_br||'3'}}px;
border-radius: {{data.theme.l1.lite_button_br||'3'}}px;
...
border: 15px solid {{data.theme.l1.lite_bg_c || '#fff'}};
height: 170px;
width: 170px;
display: block;
-webkit-border-radius: 50%;
...
<div class="wpmchimpa-overlay-bg wpmchimpa-wrapper" id="lightbox1">
	<div id="wpmchimpa-main" ng-class="{'lsoconly':data.theme.l1.lite_dislogo,'limgonly':data.theme.l1.lite_dissoc,'woleft':data.theme.l1.lite_dislogo&&data.theme.l1.lite_dissoc}">
        <div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="8" data-lhint="Go to Additional Theme Options" style="margin:25px;bottom:0">7</div>
		...
		<div id="wpmchimpa-newsletterform">
          ...
          <div>
          	...
          	<div class="lite_spinner" ng-bind-html="getSpin(data.theme.l1.lite_spinner_t||'7','wpmchimpa-wrapper',data.theme.l1.lite_spinner_c||'#000')"></div>
          </div>
