...
height: 718px;
display: block;
background-color: {{data.theme.s0.slider_bg_c||'#333'}};
color:#fff;
position: relative;
}
...
background-image:{{getIcon(data.theme.s0.slider_check_mark||'ch1',12,data.theme.s0.slider_check_ic||'#fff')}};
}
#wpmchimpas .slider_check:hover .cbox:after{
background-image:{{getIcon(data.theme.s0.slider_check_mark||'ch1',12,'#444')}};
opacity: 0.5;
}
...
-webkit-border-radius: {{data.theme.s0.slider_button_br||'1'}}px;
-moz-border-radius: {{data.theme.s0.slider_button_br||'1'}}px;
border-radius: {{data.theme.s0.slider_button_br||'1'}}px;
...
content:{{getIcon('a01',32,data.theme.s0.slider_trigger_c||'#fff')}};
height: 32px;
width: 32px;
display: block;
margin: 8px;
...
<div id="wpmchimpas" class="{{data.theme.s0.slider_bg_p}}">
<div class="wpmchimpas-inner">
<div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="9" data-lhint="Go to Additional Theme Options" style="top:0">8</div>
  ...
  <div>
    <div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="5" data-lhint="Go to Spinner Settings" style="right:0;">5</div>
    <div class="wpmchimpa-signal" ng-bind-html="getSpin(data.theme.s0.slider_spinner_t||'1','wpmchimpas-inner',data.theme.s0.slider_spinner_c||'#fff')"></div>
  </div>
</div>
</div>