...
background-image:{{getIcon(data.theme.a0.addon_check_mark||'ch1',12,data.theme.a0.addon_check_ic||'#fff')}};
}
.wpmchimpab .addon_check:hover .cbox:after{
background-image:{{getIcon(data.theme.a0.addon_check_mark||'ch1',12,'#444')}};
opacity: 0.5;
}
...
-webkit-border-radius: {{data.theme.a0.addon_button_br||'1'}}px;
-moz-border-radius: {{data.theme.a0.addon_button_br||'1'}}px;
border-radius: {{data.theme.a0.addon_button_br||'1'}}px;
...
<div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="10" data-lhint="Go to Additional Theme Options" style="margin:-30px">7</div>
 ...
 <div style="clear:both"></div>
    <div>
    <div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="7" data-lhint="Go to Spinner Settings" style="left:30px;">5</div>
    <div class="wpmchimpa-signal" ng-bind-html="getSpin(data.theme.a0.addon_spinner_t||'1','wpmchimpab',data.theme.a0.addon_spinner_c||'#000')"></div>
  </div>
</div>