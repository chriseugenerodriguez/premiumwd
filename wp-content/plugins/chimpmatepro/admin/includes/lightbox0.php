...
-webkit-border-radius: {{data.theme.l0.lite_button_br||'1'}}px;
-moz-border-radius: {{data.theme.l0.lite_button_br||'1'}}px;
border-radius: {{data.theme.l0.lite_button_br||'1'}}px;
...
background-image:{{getIcon(data.theme.l0.lite_check_mark||'ch1',12,data.theme.l0.lite_check_ic||'#fff')}};
}
#wpmchimpa .lite_check:hover .cbox:after{
background-image:{{getIcon(data.theme.l0.lite_check_mark||'ch1',12,'#444')}};
opacity: 0.5;
}
	...
	<div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="7" data-lhint="Go to Additional Theme Options" style="margin:15px;bottom:0;">6</div>
		<div class="wpmchimpa-wrapper">
			<div id="wpmchimpa-newsletterform">
	    		...
	    		<div>
	    			<div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="5" data-lhint="Go to Spinner Settings" style="right: 10%;">5</div>
        			<div class="wpmchimpa-signal" ng-bind-html="getSpin(data.theme.l0.lite_spinner_t||'1','wpmchimpa-wrapper',data.theme.l0.lite_spinner_c||'#fff')"></div>
        		</div>
    			</div>
			</div>
		</div>
