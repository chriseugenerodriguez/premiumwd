...
height: 718px;
display: block;
background-color: {{data.theme.s1.slider_canvas_c||'#333'}};
position: relative;
}
...
background-image:{{getIcon(data.theme.s1.slider_check_mark||'ch6',16,data.theme.s1.slider_check_ic||'#000')}};
}
...
-webkit-border-radius: {{data.theme.s1.slider_button_br||'3'}}px;
-moz-border-radius: {{data.theme.s1.slider_button_br||'3'}}px;
border-radius: {{data.theme.s1.slider_button_br||'3'}}px;
...
content:{{getIcon('a04',32,data.theme.s1.slider_trigger_c||'#fff')}};
height: 32px;
width: 32px;
display: block;
margin: 8px;
...
<div id="wpmchimpas" class="{{data.theme.s1.slider_bg_p}}">
<div class="wpmchimpas-inner">
  <div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="9" data-lhint="Go to Additional Theme Options" style="margin:-15px">8</div>
        ...
        <div class="wpmchimpas">
          ...
          <div id="slider_tag" ng-bind-html="data.theme.s1.slider_tag||'Secure and Spam free...' | safe"></div></div>
          <div>
            <div>
              <div class="wpmc-live-sc" ng-click="gotos($event)" data-optno="5" data-lhint="Go to Spinner Settings" style="right: -20px;">5</div>
              <div class="slider_spinner" ng-bind-html="getSpin(data.theme.s1.slider_spinner_t||'7','wpmchimpas',data.theme.s1.slider_spinner_c||'#000')"></div>
            </div>
