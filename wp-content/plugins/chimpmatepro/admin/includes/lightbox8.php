...
border:1px solid {{data.theme.l8.lite_check_borc}};
background-color: {{data.theme.l8.lite_check_c||'#fff'}};
}
#wpmchimpa .lite_check .ctext{
color: {{data.theme.l8.lite_check_fc||'#fff'}};
font-size: {{data.theme.l8.lite_check_fs||'12'}}px;
...
background-image:{{getIcon(data.theme.l8.lite_check_mark||'ch2',8,data.theme.l8.lite_check_ic||'#000')}};
}
		...
		<div id="wpmchimpa-newsletterform">
          ...
          <div><div class="wpmc-live-sc righthov" ng-click="gotos($event)" data-optno="4" data-lhint="Go to Button Settings" style="right: -20px;">4</div>
    		...
    		<div>
	          	...
	          	<div class="lite_spinner" ng-bind-html="getSpin(data.theme.l8.lite_spinner_t||'3','wpmchimpa-wrapper',data.theme.l8.lite_spinner_c||'#000')"></div>
	        </div>
          </div>
