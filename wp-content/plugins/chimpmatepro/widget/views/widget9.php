...
pointer-events: none;
  ...
  if($theme["widget_button_i"] != 'inone' && $theme["widget_button_i"] != 'idef'){
    $col = ((isset($theme["widget_button_fc"]))? $theme["widget_button_fc"] : '#fff');
     echo 'background: '.$plugin->getIcon($theme["widget_button_i"],15,$col).' no-repeat center;';
  }
  ?>
}
...
'type' => 2,
'sig' => $plugin->getSpin(isset($theme["widget_spinner_t"])?$theme["widget_spinner_t"]:'8',$wpmcw_id,isset($theme["widget_spinner_c"])?$theme["widget_spinner_c"]:'#000')
);
