...
<div id="primary" class="container"> 
  ...
  <div class="entry-content">
    <div class="user-account">
      <div class="picture">
        <?php global $user_ID; echo get_avatar($user_ID);  ?>
        <ul>
          <li class="name"><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>">
            <?php global $user_ID; echo $current_user->display_name ?>
            </a></li>
      ...
      <ul class="account">
        ...
        <li class="active"><a href="/my-account/rewards/"><em class="fa fa-heart"></em> Rewards</a></li>
    ...
    <div class="woocommerce">
      <div class="my-account">
        ...
        <?php wc_get_template( 'myaccount/my-orders.php', array( 'order_count' => 0) ); ?>
