 ...
 *
 * @uses      premiumwd_register_settings()
 *
 * @return    void
 *
 * @access    public
 * @since     2.1
 */
if ( ! function_exists( 'premiumwd_register_theme_options_page' ) ) {

  function premiumwd_register_theme_options_page() {
  
    /* get the settings array */
    $get_settings = get_option( premiumwd_settings_id() );
    ...
    if ( function_exists( 'premiumwd_register_settings' ) && Premiumwd_USE_THEME_OPTIONS ) {
      
      premiumwd_register_settings( array(
          array(
            'id'                  => premiumwd_options_id(),
            'pages'               => array( 
              array(
                'id'              => 'premiumwd_theme_options',
                'parent_slug'     => apply_filters( 'premiumwd_theme_options_parent_slug', 'themes.php' ),
                'page_title'      => apply_filters( 'premiumwd_theme_options_page_title', __( 'Theme Options', 'option-tree' ) ),
                'menu_title'      => apply_filters( 'premiumwd_theme_options_menu_title', __( 'Theme Options', 'option-tree' ) ),
                'capability'      => $caps = apply_filters( 'premiumwd_theme_options_capability', 'edit_theme_options' ),
                'menu_slug'       => apply_filters( 'premiumwd_theme_options_menu_slug', 'premiumwd-theme-options' ),
                'icon_url'        => apply_filters( 'premiumwd_theme_options_icon_url', null ),
                'position'        => apply_filters( 'premiumwd_theme_options_position', null ),
                'updated_message' => apply_filters( 'premiumwd_theme_options_updated_message', __( 'Theme Options updated.', 'option-tree' ) ),
                'reset_message'   => apply_filters( 'premiumwd_theme_options_reset_message', __( 'Theme Options reset.', 'option-tree' ) ),
                'button_text'     => apply_filters( 'premiumwd_theme_options_button_text', __( 'Save Changes', 'option-tree' ) ),
                'screen_icon'     => 'themes',
                'contextual_help' => apply_filters( 'premiumwd_theme_options_contextual_help', $contextual_help ),
                'sections'        => apply_filters( 'premiumwd_theme_options_sections', $sections ),
                'settings'        => apply_filters( 'premiumwd_theme_options_settings', $settings )
              )
            )
          )
        ) 
      ...
      add_filter( 'option_page_capability_' . premiumwd_options_id(), create_function( '$caps', "return '$caps';" ), 999 );
 ...
 * @since     2.1
 */
if ( ! function_exists( 'premiumwd_register_settings_page' ) ) {

  function premiumwd_register_settings_page() {
    global $premiumwd_has_custom_theme_options;
    
    // Display UI Builder admin notice
    if ( Premiumwd_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'premiumwd-settings' && ( $premiumwd_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) ) ) {
      
      function premiumwd_has_custom_theme_options() {
      ...
      add_action( 'admin_notices', 'premiumwd_has_custom_theme_options' );
  
    }
    
    // Create the filterable pages array
    $premiumwd_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => __( 'OptionTree', 'option-tree' ),
        'menu_title'      => __( 'OptionTree', 'option-tree' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'premiumwd-settings',
        'icon_url'        => null,
        'position'        => 61,
        'hidden_page'     => true
      ),
      array(
        'id'              => 'settings',
        'parent_slug'     => 'premiumwd-settings',
      ...
      array(
        ...
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'premiumwd-documentation',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => __( 'Theme Options updated.', 'option-tree' ),
        'reset_message'   => __( 'Theme Options reset.', 'option-tree' ),
        ...
        'settings'        => array(
          ...
          array(
            'id'          => 'functions_premiumwd_get_option',
            'label'       => __( 'Function Reference:premiumwd_get_option()', 'option-tree' ),
            'type'        => 'premiumwd-get-option',
            'section'     => 'functions'
          ),
          array(
    ...
    foreach( $premiumwd_register_pages_array as $key => $page ) {
      ...
      if ( $page['id'] == 'settings' ) {
        ...
        if ( Premiumwd_SHOW_SETTINGS_IMPORT == false ) {
        ...
        if ( Premiumwd_SHOW_SETTINGS_EXPORT == false ) {
        ...
        if ( Premiumwd_SHOW_NEW_LAYOUT == false ) {
      ...
      if ( Premiumwd_SHOW_DOCS == false && $page['id'] == 'documentation' ) {
        
        unset( $premiumwd_register_pages_array[$key] );
      
      }
    
    }
    
    $premiumwd_register_pages_array = apply_filters( 'premiumwd_register_pages_array', $premiumwd_register_pages_array );
    
    // Register the pages.
    premiumwd_register_settings( array(
        array(
          'id'              => premiumwd_settings_id(),
          'pages'           => $premiumwd_register_pages_array
        )
      )
    );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_after_theme_options_save' ) ) {

  function premiumwd_after_theme_options_save() {
    ...
    if ( apply_filters( 'premiumwd_theme_options_menu_slug', 'premiumwd-theme-options' ) == $page && $updated ) {
      
      /* grab a copy of the theme options */
      $options = get_option( premiumwd_options_id() );
      
      /* execute the action hook and pass the theme options to it */
      do_action( 'premiumwd_after_theme_options_save', $options );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_validate_setting' ) ) {

  function premiumwd_validate_setting( $input, $type, $field_id, $wmpl_id = '' ) {
    
    /* exit early if missing data */
    if ( ! $input || ! $type || ! $field_id )
      return $input;
    
    $input = apply_filters( 'premiumwd_validate_setting', $input, $type, $field_id );
    
    /* WPML Register and Unregister strings */
    if ( ! empty( $wmpl_id ) ) {
    
      /* Allow filtering on the WPML option types */
      $single_string_types = apply_filters( 'premiumwd_wpml_option_types', array( 'text', 'textarea', 'textarea-simple' ) );
              
      if ( in_array( $type, $single_string_types ) ) {
      
        if ( ! empty( $input ) ) {
        
          premiumwd_wpml_register_string( $wmpl_id, $input );
          
        } else {
        
          premiumwd_wpml_unregister_string( $wmpl_id );
    ...
    if ( 'background' == $type ) {
      ...
      $input['background-color'] = premiumwd_validate_setting( $input['background-color'], 'colorpicker', $field_id );
      
      $input['background-image'] = premiumwd_validate_setting( $input['background-image'], 'upload', $field_id );
      ...
      if ( ! current_user_can( 'unfiltered_html' ) && Premiumwd_ALLOW_UNFILTERED_HTML == false ) {
      ...
      $input['font-color'] = premiumwd_validate_setting( $input['font-color'], 'colorpicker', $field_id );
    ...
    $input = apply_filters( 'premiumwd_after_validate_setting', $input, $type, $field_id );
...
add_action( 'admin_print_scripts-post-new.php', 'premiumwd_admin_scripts', 11 );
add_action( 'admin_print_scripts-post.php', 'premiumwd_admin_scripts', 11 );
              
        /* add styles for metaboxes to post-new.php & post.php */
add_action( 'admin_print_styles-post-new.php', 'premiumwd_admin_styles', 11 );
add_action( 'admin_print_styles-post.php', 'premiumwd_admin_styles', 11 );

if ( ! function_exists( 'premiumwd_admin_styles' ) ) {

  function premiumwd_admin_styles() {
    global $wp_styles;
    ...
    /* load admin styles */
    wp_enqueue_style( 'premiumwd-admin-css', get_template_directory_uri().'/includes/blog/meta-boxes/assets/css/premiumwd-admin.css', false, '1.0.0' );

  }
  
}
		
if ( ! function_exists( 'premiumwd_admin_scripts' ) ) {

  function premiumwd_admin_scripts() {
    ...
    wp_enqueue_script( 'jquery-ui-timepicker',  get_template_directory_uri().'/includes/blog/meta-boxes/assets/js/vendor/jquery/jquery-ui-timepicker.js', array( 'jquery', 'jquery-ui-slider', 'jquery-ui-datepicker' ), '1.4.3' );
    
    /* load all the required scripts */
    wp_enqueue_script( 'premiumwd-admin-js',  get_template_directory_uri().'/includes/blog/meta-boxes/assets/js/premiumwd-admin.js', array( 'jquery', 'jquery-ui-tabs', 'jquery-ui-sortable', 'jquery-ui-slider', 'wp-color-picker', 'jquery-ui-datepicker', 'jquery-ui-timepicker' ), '1.0.0');
    ...
    wp_localize_script( 'premiumwd-admin-js', 'option_tree', $localized_array );
 ...
 * @since       2.0
 */
if ( ! function_exists( 'premiumwd_get_media_post_ID' ) ) {

  function premiumwd_get_media_post_ID() {
    global $wpdb;
 ...
 * @since       2.0
 */
if ( ! function_exists( 'premiumwd_create_media_post' ) ) {
  
  function premiumwd_create_media_post() {
    ...
    $post_id = premiumwd_get_media_post_ID();
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_default_settings' ) ) {

  function premiumwd_default_settings() {
    global $wpdb, $table_prefix;
    
    if ( ! get_option( premiumwd_settings_id() ) ) {
      ...
      if ( count( $wpdb->get_results( "SHOW TABLES LIKE '{$table_prefix}option_tree'" ) ) == 1 && $old_settings = $wpdb->get_results( "SELECT * FROM {$table_prefix}option_tree ORDER BY item_sort ASC" ) ) {
        ...
        foreach ( $old_settings as $setting ) {
          ...
          if ( $setting->item_type == 'heading' ) {
            ...
            $settings['settings'][$settings_count]['type'] = premiumwd_map_old_option_types( $setting->item_type );
            ...
            if ( in_array( $settings['settings'][$settings_count]['type'], array( 'checkbox', 'radio', 'select' ) ) ) {
              if ( '' != $setting->item_options ) {
                $choices = premiumwd_convert_string_to_array( $setting->item_options );
              }
            }
      ...
      update_option( premiumwd_settings_id(), $settings );
      ...
      if ( is_array( $options ) ) {
        ...
        foreach( $settings['settings'] as $setting ) {
          ...
          if ( isset( $options[$setting['id']] ) ) {
            ...
            $content = premiumwd_stripslashes( $options[$setting['id']] );
            
            $options[$setting['id']] = premiumwd_validate_setting( $content, $setting['type'], $setting['id'] );
        ...
        /* execute the action hook and pass the theme options to it */
        do_action( 'premiumwd_before_theme_options_save', $options );
        
        /* update the option tree array */
        update_option( premiumwd_options_id(), $options );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_save_css' ) ) {

  function premiumwd_save_css( $options ) {
    
    /* grab a copy of the settings */
    $settings = get_option( premiumwd_settings_id() );
      ...
      foreach( $settings['settings'] as $k => $setting ) {
        ...
        if ( isset( $setting['type'] ) && 'css' == $setting['type'] ) {
          ...
          if ( isset( $options[$setting['id']] ) && '' !== $options[$setting['id']] ) {
            ...
            premiumwd_insert_css_with_markers( $setting['id'], $options[$setting['id']] );
          
          /* remove old CSS from dynamic.css */
          } else {
          
            premiumwd_remove_old_css( $setting['id'] );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_add_xml_to_upload_filetypes' ) ) {

  function premiumwd_add_xml_to_upload_filetypes() {
    
    add_filter( 'upload_mimes', 'premiumwd_upload_mimes' );
    add_filter( 'wp_mime_type_icon', 'premiumwd_xml_mime_type_icon', 10, 2 );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_upload_mimes' ) ) {

  function premiumwd_upload_mimes( $mimes ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_xml_mime_type_icon' ) ) {

  function premiumwd_xml_mime_type_icon( $icon, $mime ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_import' ) ) {

  function premiumwd_import() {
    ...
    if ( isset( $_POST['import_xml_nonce'] ) && wp_verify_nonce( $_POST['import_xml_nonce'], 'import_xml_form' ) ) {
      ...
      if ( preg_match( "/(.xml)$/i", $file ) && class_exists( 'SimpleXMLElement' ) ) {
        ...
        $settings = premiumwd_import_xml( $file );
    ...
    if ( isset( $_POST['import_settings_nonce'] ) && wp_verify_nonce( $_POST['import_settings_nonce'], 'import_settings_form' ) ) {
      ...
      /* textarea value */
      $textarea = isset( $_POST['import_settings'] ) ? unserialize( premiumwd_decode( $_POST['import_settings'] ) ) : '';
      ...
      if ( is_array( $textarea ) ) {
        update_option( premiumwd_settings_id(), $textarea );
        $message = 'success';
      }
    ...
    if ( isset( $_POST['import_data_nonce'] ) && wp_verify_nonce( $_POST['import_data_nonce'], 'import_data_form' ) ) {
      ...
      /* textarea value */
      $options = isset( $_POST['import_data'] ) ? unserialize( premiumwd_decode( $_POST['import_data'] ) ) : '';
    ...
    if ( isset( $_POST['import_layouts_nonce'] ) && wp_verify_nonce( $_POST['import_layouts_nonce'], 'import_layouts_form' ) ) {
      ...
      /* textarea value */
      $layouts = isset( $_POST['import_layouts'] ) ? unserialize( premiumwd_decode( $_POST['import_layouts'] ) ) : '';
      ...
      if ( is_array( $layouts ) ) {
        ...
        if ( is_array( $settings ) ) {
          ...
          foreach( $layouts as $key => $value ) {
            ...
            $options = unserialize( premiumwd_decode( $value ) );
            ...
            $layouts[$key] = premiumwd_encode( serialize( $options ) );
        ...
        if ( isset( $layouts['active_layout'] ) ) {
          ...
          $new_options = unserialize( premiumwd_decode( $layouts[$layouts['active_layout']] ) );
          
          /* execute the action hook and pass the theme options to it */
          do_action( 'premiumwd_before_theme_options_save', $new_options );
        
          update_option( premiumwd_options_id(), $new_options );
          
        }
        
        /* update the option tree layouts array */
        update_option( premiumwd_layouts_id(), $layouts );
 ...
 * @since     2.0.8
 */
if ( ! function_exists( 'premiumwd_export' ) ) {

  function premiumwd_export() {
    ...
    if ( isset( $_POST['export_settings_file_nonce'] ) && wp_verify_nonce( $_POST['export_settings_file_nonce'], 'export_settings_file_form' ) ) {
      ...
      premiumwd_export_php_settings_array();
 ...
 * @since     2.0.8
 */
if ( ! function_exists( 'premiumwd_import_xml' ) ) {

  function premiumwd_import_xml( $file ) {
    ...
    if ( $rawdata ) {
      ...
      foreach ( $xml->row as $value ) {
        ...
        if ( $value->item_type == 'heading' ) {
          ...
          $settings['settings'][$settings_count]['section'] = $section;
          $settings['settings'][$settings_count]['type'] = premiumwd_map_old_option_types( (string) $value->item_type );
          $settings['settings'][$settings_count]['std'] = '';
          $settings['settings'][$settings_count]['class'] = '';
          ...
          if ( in_array( $settings['settings'][$settings_count]['type'], array( 'checkbox', 'radio', 'select' ) ) ) {
            if ( '' != (string) $value->item_options ) {
              $choices = premiumwd_convert_string_to_array( (string) $value->item_options );
            }
          }
          $settings['settings'][$settings_count]['choices'] = $choices;
 ...
 * @since     2.0.8
 */
if ( ! function_exists( 'premiumwd_export_php_settings_array' ) ) {

  function premiumwd_export_php_settings_array() {
    ...
    $sections             = '';
    $settings             = '';
    $option_tree_settings = get_option( premiumwd_settings_id(), array() );
    
    // Domain string helper
    function premiumwd_I18n_string( $string ) {
    ...
    if ( isset( $option_tree_settings['contextual_help']['content'] ) ) {
      ...
      foreach( $option_tree_settings['contextual_help']['content'] as $value ) {
        ...
        $_title = premiumwd_I18n_string( isset( $value['title'] ) ? str_replace( "'", "\'", $value['title'] ) : '' );
        $_content = premiumwd_I18n_string( isset( $value['content'] ) ? html_entity_decode(  str_replace( "'", "\'", $value['content'] ) ) : '' );
        $help.= "
        array(
          'id'        => '$_id',
          'title'     => $_title,
    ...
    if ( isset( $option_tree_settings['contextual_help']['sidebar'] ) ) {
      $contextual_help.= "
      'sidebar'       => " . premiumwd_I18n_string( html_entity_decode(  str_replace( "'", "\'", $option_tree_settings['contextual_help']['sidebar'] ) ) );
    }
    ...
    if ( isset( $option_tree_settings['settings'] ) ) {
      foreach( $option_tree_settings['settings'] as $value ) {
        $_id = isset( $value['id'] ) ? $value['id'] : '';
        $_label = premiumwd_I18n_string( isset( $value['label'] ) ? str_replace( "'", "\'", $value['label'] ) : '' );
        $_desc = premiumwd_I18n_string( isset( $value['desc'] ) ? str_replace( "'", "\'", $value['desc'] ) : '' );
        ...
        if ( isset( $value['choices'] ) && ! empty( $value['choices'] ) ) {
          foreach( $value['choices'] as $choice ) {
            ...
            $_choice_label = premiumwd_I18n_string( isset( $choice['label'] ) ? str_replace( "'", "\'", $choice['label'] ) : '' );
...
' . implode( ",\n", $std_array ) . '
        ...
        if ( isset( $value['settings'] ) && ! empty( $value['settings'] ) ) {
          foreach( $value['settings'] as $setting ) {
            ...
            $_setting_label = premiumwd_I18n_string( isset( $setting['label'] ) ? str_replace( "'", "\'", $setting['label'] ) : '' );
            $_setting_desc = premiumwd_I18n_string( isset( $setting['desc'] ) ? str_replace( "'", "\'", $setting['desc'] ) : '' );
            ...
            if ( isset( $setting['choices'] ) && ! empty( $setting['choices'] ) ) {
              foreach( $setting['choices'] as $setting_choice ) {
                ...
                $_setting_choice_label = premiumwd_I18n_string( isset( $setting_choice['label'] ) ? str_replace( "'", "\'", $setting_choice['label'] ) : '' );
...
function custom_theme_options() {
  ...
  if ( ! function_exists( 'premiumwd_settings_id' ) )
    return false;
    
  /**
   * Get a copy of the saved settings array. 
   */
  \$saved_settings = get_option( premiumwd_settings_id(), array() );
  ...
  \$custom_settings = apply_filters( premiumwd_settings_id() . '_args', \$custom_settings );
  
  /* settings are not the same update the DB */
  if ( \$saved_settings !== \$custom_settings ) {
    update_option( premiumwd_settings_id(), \$custom_settings ); 
  }
  
  /* Lets OptionTree know the UI Builder is being overridden */
  global \$premiumwd_has_custom_theme_options;
  \$premiumwd_has_custom_theme_options = true;
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_save_settings' ) ) {

  function premiumwd_save_settings() {

    /* check and verify import settings nonce */
    if ( isset( $_POST['option_tree_settings_nonce'] ) && wp_verify_nonce( $_POST['option_tree_settings_nonce'], 'option_tree_settings_form' ) ) {

      /* settings value */
      $settings = isset( $_POST[premiumwd_settings_id()] ) ? $_POST[premiumwd_settings_id()] : '';
      ...
      if ( isset( $settings['sections'] ) ) {
        ...
        foreach( $settings['sections'] as $k => $section ) {
          ...
          if ( ( ! isset( $section['title'] ) && ! isset( $section['id'] ) ) || ( '' == $section['title'] && '' == $section['id'] ) ) {
            ...
            $settings['sections'][$k]['id'] = premiumwd_sanitize_option_id( wp_kses_post( $section['id'] ) );
            
          }
          
        }
        
        $settings['sections'] = premiumwd_stripslashes( $settings['sections'] );
      ...
      if ( isset( $settings['settings'] ) ) {
        ...
        $settings['settings'] = premiumwd_validate_settings_array( $settings['settings'] );
      ...
      if ( isset( $settings['contextual_help']['content'] ) ) {
        ...
        foreach( $settings['contextual_help']['content'] as $k => $content ) {
          ...
          if ( ( ! isset( $content['title'] ) && ! isset( $content['id'] ) ) || ( '' == $content['title'] && '' == $content['id'] ) ) {
            ...
            /* sanitize ID once everything has been checked first */
            $settings['contextual_help']['content'][$k]['id'] = premiumwd_sanitize_option_id( wp_kses_post( $content['id'] ) );
      ...
      $settings['contextual_help'] = premiumwd_stripslashes( $settings['contextual_help'] );
      ...
      if ( is_array( $settings ) ) {
        ...
        if ( function_exists( 'icl_unregister_string' ) ) {
          ...
          $current = get_option( premiumwd_settings_id() );
          $options = get_option( premiumwd_options_id() );
                ...
                if ( ! empty( $options[$current_setting['id']] ) && in_array( $current_setting['type'], array( 'list-item', 'slider' ) ) ) {
                  ...
                  foreach( $options[$current_setting['id']] as $key => $value ) {
                    ...
                    foreach( $value as $ckey => $cvalue ) {
                      ...
                      premiumwd_wpml_unregister_string( $current_setting['id'] . '_' . $ckey . '_' . $key );
                  ...
                  premiumwd_wpml_unregister_string( $current_setting['id'] );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_validate_settings_array' ) ) {

  function premiumwd_validate_settings_array( $settings = array() ) {
    ...
    if ( count( $settings ) > 0 ) {
      ...
      foreach( $settings as $k => $setting ) {
        ...
        if ( ( ! isset( $setting['label'] ) && ! isset( $setting['id'] ) ) || ( '' == $setting['label'] && '' == $setting['id'] ) ) {
          ...
          /* sanitize ID once everything has been checked first */
          $settings[$k]['id'] = premiumwd_sanitize_option_id( wp_kses_post( $setting['id'] ) );
          ...
          foreach( $setting['choices'] as $ck => $choice ) {
            ...
            if ( ( ! isset( $choice['label'] ) && ! isset( $choice['value'] ) ) || ( '' == $choice['label'] && '' == $choice['value'] ) ) {
              ...
              /* missing value set to label */ 
                ...
                $setting['choices'][$ck]['value'] = premiumwd_sanitize_option_id( wp_kses_post( $choice['label'] ) );
        ...
        if ( isset( $setting['settings'] ) ) {
          ...
          $settings[$k]['settings'] = premiumwd_validate_settings_array( $setting['settings'] );
    ...
    return premiumwd_stripslashes( $settings );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_modify_layouts' ) ) {

  function premiumwd_modify_layouts() {
    ...
    if ( isset( $_POST['option_tree_modify_layouts_nonce'] ) && wp_verify_nonce( $_POST['option_tree_modify_layouts_nonce'], 'option_tree_modify_layouts_form' ) ) {
      ...
      $option_tree_layouts = get_option( premiumwd_layouts_id() );
      
      /* new layouts value */
      $layouts = isset( $_POST[premiumwd_layouts_id()] ) ? $_POST[premiumwd_layouts_id()] : '';
      ...
      if ( is_array( $layouts ) && ! empty( $layouts ) ) {
        ...
        if ( isset( $layouts['_add_new_layout_'] ) && ! empty( $layouts['_add_new_layout_'] ) ) {
          $rebuild['active_layout'] = premiumwd_sanitize_layout_id( $layouts['_add_new_layout_'] );
          $rebuild[$rebuild['active_layout']] = premiumwd_encode( serialize( get_option( premiumwd_options_id() ) ) );
        }
      ...
      if ( count( $rebuild ) > 1 ) {
        ...
        $rebuild_option_tree = unserialize( premiumwd_decode( $rebuild[$rebuild['active_layout']] ) );
        if ( is_array( $rebuild_option_tree ) ) {
          
          /* execute the action hook and pass the theme options to it */
          do_action( 'premiumwd_before_theme_options_save', $rebuild_option_tree );
          
          update_option( premiumwd_options_id(), $rebuild_option_tree );
          
        }
        
        /* rebuild the layouts */
        update_option( premiumwd_layouts_id(), $rebuild );
        ...
        delete_option( premiumwd_layouts_id() );
      ...
      /* redirect */
      if ( isset( $_REQUEST['page'] ) && $_REQUEST['page'] == apply_filters( 'premiumwd_theme_options_menu_slug', 'premiumwd-theme-options' ) ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_alert_message' ) ) {

  function premiumwd_alert_message( $page = array() ) {
    
    if ( empty( $page ) )
      return false;
    
    $before = apply_filters( 'premiumwd_before_page_messages', '', $page );
    ...
    do_action( 'premiumwd_custom_page_messages', $page );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_option_types_array' ) ) {

  function premiumwd_option_types_array() {
  
    return apply_filters( 'premiumwd_option_types_array', array( 
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_map_old_option_types' ) ) {

  function premiumwd_map_old_option_types( $type = '' ) {
 ...
 * @updated   2.0
 */
if ( ! function_exists( 'premiumwd_recognized_font_families' ) ) {

  function premiumwd_recognized_font_families( $field_id = '' ) {
  
    return apply_filters( 'premiumwd_recognized_font_families', array(
      'arial'     => 'Arial',
      'georgia'   => 'Georgia',
      'helvetica' => 'Helvetica',
      'palatino'  => 'Palatino',
 ...
 * @since     2.0.12
 */
if ( ! function_exists( 'premiumwd_recognized_font_sizes' ) ) {

  function premiumwd_recognized_font_sizes( $field_id ) {
  
    $range = premiumwd_range( 
      apply_filters( 'premiumwd_font_size_low_range', 0, $field_id ), 
      apply_filters( 'premiumwd_font_size_high_range', 150, $field_id ), 
      apply_filters( 'premiumwd_font_size_range_interval', 1, $field_id )
    );
    
    $unit = apply_filters( 'premiumwd_font_size_unit_type', 'px', $field_id );
    
    foreach( $range as $k => $v ) {
      $range[$k] = $v . $unit;
    }
    
    return apply_filters( 'premiumwd_recognized_font_sizes', $range, $field_id );
  }
 ...
 * @updated   2.0
 */
if ( ! function_exists( 'premiumwd_recognized_font_styles' ) ) {

  function premiumwd_recognized_font_styles( $field_id = '' ) {
  
    return apply_filters( 'premiumwd_recognized_font_styles', array(
      'normal'  => 'Normal',
      'italic'  => 'Italic',
      'oblique' => 'Oblique',
      'inherit' => 'Inherit'
 ...
 * @updated   2.0
 */
if ( ! function_exists( 'premiumwd_recognized_font_variants' ) ) {

  function premiumwd_recognized_font_variants( $field_id = '' ) {
  
    return apply_filters( 'premiumwd_recognized_font_variants', array(
      'normal'      => 'Normal',
 ...
 * @updated   2.0
 */
if ( ! function_exists( 'premiumwd_recognized_font_weights' ) ) {

  function premiumwd_recognized_font_weights( $field_id = '' ) {
    
    return apply_filters( 'premiumwd_recognized_font_weights', array(
      'normal'    => 'Normal',
      'bold'      => 'Bold',
      'bolder'    => 'Bolder',
      'lighter'   => 'Lighter',
 ...
 * @since     2.0.12
 */
if ( ! function_exists( 'premiumwd_recognized_letter_spacing' ) ) {

  function premiumwd_recognized_letter_spacing( $field_id ) {
  
    $range = premiumwd_range( 
      apply_filters( 'premiumwd_letter_spacing_low_range', -0.1, $field_id ), 
      apply_filters( 'premiumwd_letter_spacing_high_range', 0.1, $field_id ), 
      apply_filters( 'premiumwd_letter_spacing_range_interval', 0.01, $field_id )
    );
    
    $unit = apply_filters( 'premiumwd_letter_spacing_unit_type', 'em', $field_id );
    
    foreach( $range as $k => $v ) {
      $range[$k] = $v . $unit;
    }
    
    return apply_filters( 'premiumwd_recognized_letter_spacing', $range, $field_id );
  }
 ...
 * @since     2.0.12
 */
if ( ! function_exists( 'premiumwd_recognized_line_heights' ) ) {

  function premiumwd_recognized_line_heights( $field_id ) {
  
    $range = premiumwd_range( 
      apply_filters( 'premiumwd_line_height_low_range', 0, $field_id ), 
      apply_filters( 'premiumwd_line_height_high_range', 150, $field_id ), 
      apply_filters( 'premiumwd_line_height_unit_type', 1, $field_id )
    );
    
    $unit = apply_filters( 'premiumwd_line_height_unit_type', 'px', $field_id );
    
    foreach( $range as $k => $v ) {
      $range[$k] = $v . $unit;
    }
    
    return apply_filters( 'premiumwd_recognized_line_heights', $range, $field_id );
  }
 ...
 * @since     2.0.10
 */
if ( ! function_exists( 'premiumwd_recognized_text_decorations' ) ) {
  
  function premiumwd_recognized_text_decorations( $field_id = '' ) {
  
    return apply_filters( 'premiumwd_recognized_text_decorations', array(
      'blink'         => 'Blink',
      'inherit'       => 'Inherit',
 ...
 * @since     2.0.10
 */
if ( ! function_exists( 'premiumwd_recognized_text_transformations' ) ) {
  
  function premiumwd_recognized_text_transformations( $field_id = '' ) {
  
    return apply_filters( 'premiumwd_recognized_text_transformations', array(
 ...
 * @updated   2.0
 */
if ( ! function_exists( 'premiumwd_recognized_background_repeat' ) ) {
  
  function premiumwd_recognized_background_repeat( $field_id = '' ) {
  
    return apply_filters( 'premiumwd_recognized_background_repeat', array(
      'no-repeat' => 'No Repeat',
      'repeat'    => 'Repeat All',
 ...
 * @updated   2.0
 */
if ( ! function_exists( 'premiumwd_recognized_background_attachment' ) ) {

  function premiumwd_recognized_background_attachment( $field_id = '' ) {
  
    return apply_filters( 'premiumwd_recognized_background_attachment', array(
      "fixed"   => "Fixed",
      "scroll"  => "Scroll",
      "inherit" => "Inherit"
    ), $field_id );
 ...
 * @updated   2.0
 */
if ( ! function_exists( 'premiumwd_recognized_background_position' ) ) {

  function premiumwd_recognized_background_position( $field_id = '' ) {
  
    return apply_filters( 'premiumwd_recognized_background_position', array(
      "left top"      => "Left Top",
 ...
 * @updated   2.0
 */
if ( ! function_exists( 'premiumwd_measurement_unit_types' ) ) {
  
  function premiumwd_measurement_unit_types( $field_id = '' ) {
  
    return apply_filters( 'premiumwd_measurement_unit_types', array(
      'px' => 'px',
      '%'  => '%',
      'em' => 'em',
      'pt' => 'pt'
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_radio_images' ) ) {
  
  function premiumwd_radio_images( $field_id = '' ) {
  
    return apply_filters( 'premiumwd_radio_images', array(
      array(
        'value'   => 'left-sidebar',
        'label'   => __( 'Left Sidebar', 'option-tree' ),
        'src'     => Premiumwd_URL . 'assets/images/layout/left-sidebar.png'
      ),
      array(
        'value'   => 'right-sidebar',
        'label'   => __( 'Right Sidebar', 'option-tree' ),
        'src'     => Premiumwd_URL . 'assets/images/layout/right-sidebar.png'
      ),
      array(
        'value'   => 'full-width',
        'label'   => __( 'Full Width (no sidebar)', 'option-tree' ),
        'src'     => Premiumwd_URL . 'assets/images/layout/full-width.png'
      ),
      array(
        'value'   => 'dual-sidebar',
        'label'   => __( 'Dual Sidebar', 'option-tree' ),
        'src'     => Premiumwd_URL . 'assets/images/layout/dual-sidebar.png'
      ),
      array(
        'value'   => 'left-dual-sidebar',
        'label'   => __( 'Left Dual Sidebar', 'option-tree' ),
        'src'     => Premiumwd_URL . 'assets/images/layout/left-dual-sidebar.png'
      ),
      array(
        'value'   => 'right-dual-sidebar',
        'label'   => __( 'Right Dual Sidebar', 'option-tree' ),
        'src'     => Premiumwd_URL . 'assets/images/layout/right-dual-sidebar.png'
      )
    ), $field_id );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_list_item_settings' ) ) {

  function premiumwd_list_item_settings( $id ) {
    
    $settings = apply_filters( 'premiumwd_list_item_settings', array(
      array(
        'id'        => 'image',
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_slider_settings' ) ) {

  function premiumwd_slider_settings( $id ) {
 ...
 * @since     2.4.0
 */
if ( ! function_exists( 'premiumwd_social_links_settings' ) ) {

  function premiumwd_social_links_settings( $id ) {
    
    $settings = apply_filters( 'premiumwd_social_links_settings', array(
      array(
        'id'        => 'name',
 ...
 * @updated   2.0.12
 */
if ( ! function_exists( 'premiumwd_insert_css_with_markers' ) ) {

  function premiumwd_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    $premiumwd_css_file_paths = get_option( 'premiumwd_css_file_paths', array() );
    
    /* set the path for this field */
    $premiumwd_css_file_paths[$field_id] = $filepath;
    
    /* update the paths */
    update_option( 'premiumwd_css_file_paths', $premiumwd_css_file_paths );
    
    /* insert CSS into file */
    if ( file_exists( $filepath ) ) {
      
      $insertion   = premiumwd_normalize_css( $insertion );
      $regex       = "/{{([a-zA-Z0-9\_\-\#\|\=]+)}}/";
      $marker      = $field_id;
      ...
      foreach( $matches[0] as $option ) {
        ...
        $option_type  = premiumwd_get_option_type_by_id( $option_id );
        ...
        if ( is_array( $value ) ) {
          ...
          if ( ! isset( $option_array[1] ) ) {
            ...
            /* typography */
            } else if ( premiumwd_array_keys_exists( $value, array( 'font-color', 'font-family', 'font-size', 'font-style', 'font-variant', 'font-weight', 'letter-spacing', 'line-height', 'text-decoration', 'text-transform' ) ) ) {
              $font = array();
              ...
              if ( ! empty( $value['font-family'] ) ) {
                foreach ( premiumwd_recognized_font_families( $marker ) as $key => $v ) {
            ...
            /* background */
            } else if ( premiumwd_array_keys_exists( $value, array( 'background-color', 'background-image', 'background-repeat', 'background-attachment', 'background-position', 'background-size' ) ) ) {
              $bg = array();
              ...
              if ( isset( $size ) ) {
                if ( ! empty( $bg ) ) {
                  $value.= apply_filters( 'premiumwd_insert_css_with_markers_bg_size_white_space', "\n\x20\x20", $option_id );
                }
        ...
        // Filter the CSS
        $value = apply_filters( 'premiumwd_insert_css_with_markers_value', $value, $option_id );
      ...
      if ( ! $f = premiumwd_file_open( $filepath, 'w' ) )
        return false;
        ...
        foreach( $markerdata as $n => $markerline ) {
          ...
          if ( $searching == true ) {
            if ( $n + 1 < count( $markerdata ) )
              premiumwd_file_write( $f, "{$markerline}\n" );
            else
              premiumwd_file_write( $f, "{$markerline}" );
          }
          ...
          if ( $markerline == "/* END {$marker} */" ) {
            premiumwd_file_write( $f, "/* BEGIN {$marker} */\n" );
            premiumwd_file_write( $f, "{$insertion}\n" );
            premiumwd_file_write( $f, "/* END {$marker} */\n" );
            $searching = true;
            $foundit = true;
          }
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_remove_old_css' ) ) {

  function premiumwd_remove_old_css( $field_id = '' ) {
 ...
 * @updated   2.0
 */
if ( ! function_exists( 'premiumwd_normalize_css' ) ) {

  function premiumwd_normalize_css( $css ) {
 ...
 * @since    2.0
 */
if ( ! function_exists( 'premiumwd_loop_through_option_types' ) ) {

  function premiumwd_loop_through_option_types( $type = '', $child = false ) {
  
    $content = '';
    $types = premiumwd_option_types_array();
 ...
 * @since    2.0
 */
if ( ! function_exists( 'premiumwd_loop_through_choices' ) ) {

  function premiumwd_loop_through_choices( $name, $choices = array() ) {
    
    $content = '';
    
    foreach( (array) $choices as $key => $choice )
      $content.= '<li class="ui-state-default list-choice">' . premiumwd_choices_view( $name, $key, $choice ) . '</li>';
 ...
 * @since    2.0
 */
if ( ! function_exists( 'premiumwd_loop_through_sub_settings' ) ) {

  function premiumwd_loop_through_sub_settings( $name, $settings = array() ) {
    
    $content = '';
    
    foreach( $settings as $key => $setting )
      $content.= '<li class="ui-state-default list-sub-setting">' . premiumwd_settings_view( $name, $key, $setting ) . '</li>';
 ...
 * @since    2.0
 */
if ( ! function_exists( 'premiumwd_sections_view' ) ) {

  function premiumwd_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . __( 'edit', 'option-tree' ) . '">
          <span class="icon premiumwd-icon-pencil"></span>' . __( 'Edit', 'option-tree' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Delete', 'option-tree' ) . '">
          <span class="icon premiumwd-icon-trash-o"></span>' . __( 'Delete', 'option-tree' ) . '
        </a>
      </div>
 ...
 * @since    2.0
 */
if ( ! function_exists( 'premiumwd_settings_view' ) ) {

  function premiumwd_settings_view( $name, $key, $setting = array() ) {
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            ...
            <div class="format-setting-inner">
              ...
              ' . premiumwd_loop_through_option_types( $type, $child ) . '                     
          ...
          <div class="format-setting type-textblock wide-desc">
            ...
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['choices'] ) ? premiumwd_loop_through_choices( $name . '[' . $key . ']', $setting['choices'] ) : '' ) . '
              </ul>
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            ...
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? premiumwd_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
 ...
 * @since    2.0
 */
if ( ! function_exists( 'premiumwd_choices_view' ) ) {

  function premiumwd_choices_view( $name, $key, $choice = array() ) {
 ...
 * @since    2.0
 */
if ( ! function_exists( 'premiumwd_contextual_help_view' ) ) {

  function premiumwd_contextual_help_view( $name, $key, $content = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_layout_view' ) ) {

  function premiumwd_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . __( 'Activate', 'option-tree' ) . '">
          <span class="icon premiumwd-icon-square-o"></span>' . __( 'Activate', 'option-tree' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="'. __( 'Delete', 'option-tree' ) . '">
          <span class="icon premiumwd-icon-trash-o"></span>' . __( 'Delete', 'option-tree' ) . '
        </a>
      </div>
      <input type="hidden" name="' . premiumwd_layouts_id() . '[' . esc_attr( $key ) . ']" value="' . $data . '" />
    </div>';
 ...
 * @since    2.0
 */
if ( ! function_exists( 'premiumwd_list_item_view' ) ) {

  function premiumwd_list_item_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
    ...
    if ( 'slider' == $type ) {
      ...
      $settings = premiumwd_slider_settings( $name );
    ...
    if ( empty( $settings ) ) {
      ...
      $settings = premiumwd_list_item_settings( $name );
    ...
    <div class="option-tree-setting">
      ...
      foreach( $settings as $field ) {
        ...
        if ( isset( $field['std'] ) ) {  
          $field_value = premiumwd_filter_std_value( $field_value, $field['std'] );
        }
        ...
        if ( $field['id'] == 'title' ) {
          ...
          // filter the label
          $field['label'] = apply_filters( 'premiumwd_list_item_title_label', $field['label'], $name );
          
          // filter the description
          $field['desc'] = apply_filters( 'premiumwd_list_item_title_desc', $field['desc'], $name );
        ...
        echo '<div id="setting_' . $_args['field_id'] . '" class="format-settings"' . $conditions . '>';
          ...
          if ( apply_filters( 'premiumwd_override_forced_textarea_simple', false, $field['id'] ) == false && $_args['type'] == 'textarea' )
            $_args['type'] = 'textarea-simple';
            
          /* option body, list-item is not allowed inside another list-item */
          if ( $_args['type'] !== 'list-item' && $_args['type'] !== 'slider' ) {
            echo premiumwd_display_by_type( $_args );
          }
 ...
 * @since     2.4.0
 */
if ( ! function_exists( 'premiumwd_social_links_view' ) ) {

  function premiumwd_social_links_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
    
    /* if no settings array load the filterable social links settings */
    if ( empty( $settings ) ) {
      
      $settings = premiumwd_social_links_settings( $name );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_theme_options_layouts_form' ) ) {

  function premiumwd_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      $layouts = get_option( premiumwd_layouts_id() );
      ...
      if ( is_array( $layouts ) && count( $layouts ) > 1 ) {
        ...
        echo '<div class="option-tree-active-layout">';
          ...
          echo '<select name="' . premiumwd_layouts_id() . '[active_layout]" class="option-tree-ui-select">';
        ...
        foreach( $layouts as $key => $data ) {
          ...
          echo '<input type="hidden" name="' . premiumwd_layouts_id() . '[' . $key . ']" value="' . ( isset( $data ) ? $data : '' ) . '" />';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        /* add new layout */
        echo '<input type="text" name="' . premiumwd_layouts_id() . '[_add_new_layout_]" value="" class="widefat option-tree-ui-input" autocomplete="off" />';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_sanitize_option_id' ) ) {

  function premiumwd_sanitize_option_id( $input ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_sanitize_layout_id' ) ) {

  function premiumwd_sanitize_layout_id( $input ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_convert_array_to_string' ) ) {

  function premiumwd_convert_array_to_string( $input ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_convert_string_to_array' ) ) {

  function premiumwd_convert_string_to_array( $input ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_strpos_array' ) ) {

  function premiumwd_strpos_array( $haystack, $needles = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_array_keys_exists' ) ) {
  
  function premiumwd_array_keys_exists( $array, $keys ) {
 ...
 * @since       2.0
 */
if ( ! function_exists( 'premiumwd_stripslashes' ) ) {

  function premiumwd_stripslashes( $input ) {
    ...
    if ( is_array( $input ) ) {
      ...
      foreach( $input as &$val ) {
        ...
        if ( is_array( $val ) ) {
          ...
          $val = premiumwd_stripslashes( $val );
 ...
 * @since     2.0.9
 */
if ( ! function_exists( 'premiumwd_reverse_wpautop' ) ) {

  function premiumwd_reverse_wpautop( $string = '' ) {
 ...
 * @since     2.0.12
 */
function premiumwd_range( $start, $limit, $step = 1 ) {
 ...
 * @since     2.0.13
 */
function premiumwd_encode( $value ) {
 ...
 * @since     2.0.13
 */
function premiumwd_decode( $value ) {
 ...
 * @since     2.0.13
 */
function premiumwd_file_open( $handle, $mode ) {
 ...
 * @since     2.0.13
 */
function premiumwd_file_close( $handle ) {
 ...
 * @since     2.0.13
 */
function premiumwd_file_write( $handle, $string ) {
 ...
 * @since     2.0.15
 */
function premiumwd_filter_std_value( $value = '', $std = '' ) {
 ...
 * @since     2.1
 */
function premiumwd_wpml_register_string( $id, $value ) {
 ...
 * @since     2.1
 */
function premiumwd_wpml_unregister_string( $id ) {
 ...
 * @since     2.3.3
 */
if ( ! function_exists( 'premiumwd_maybe_migrate_settings' ) ) {

  function premiumwd_maybe_migrate_settings() {
    
    // Filter the ID to migrate from
    $settings_id = apply_filters( 'premiumwd_migrate_settings_id', '' );
    
    // Attempt to migrate Settings 
    if ( ! empty( $settings_id ) && get_option( premiumwd_settings_id() ) === false && premiumwd_settings_id() !== $settings_id ) {
 ...
 * @since     2.3.3
 */
if ( ! function_exists( 'premiumwd_maybe_migrate_options' ) ) {

  function premiumwd_maybe_migrate_options() {
    
    // Filter the ID to migrate from
    $options_id = apply_filters( 'premiumwd_migrate_options_id', '' );
    
    // Attempt to migrate Theme Options
    if ( ! empty( $options_id ) && get_option( premiumwd_options_id() ) === false && premiumwd_options_id() !== $options_id ) {
 ...
 * @since     2.3.3
 */
if ( ! function_exists( 'premiumwd_maybe_migrate_layouts' ) ) {

  function premiumwd_maybe_migrate_layouts() {
    
    // Filter the ID to migrate from
    $layouts_id = apply_filters( 'premiumwd_migrate_layouts_id', '' );
    
    // Attempt to migrate Layouts
    if ( ! empty( $layouts_id ) && get_option( premiumwd_layouts_id() ) === false && premiumwd_layouts_id() !== $layouts_id ) {
 ...
 * @since     2.4.0
 */
function premiumwd_meta_box_post_format_gallery( $pages = 'post' ) {
  ...
  return apply_filters( 'premiumwd_meta_box_post_format_gallery', array(
    'id'        => 'premiumwd-post-format-gallery',
    ...
    'fields'    => array(
      array(
        ...
        'std'         => '',
        'type'        => 'gallery',
        'class'       => 'premiumwd-gallery-shortcode'
      )
  	)
  ), $pages );
 ...
 * @since     2.4.0
 */
function premiumwd_meta_box_post_format_link( $pages = 'post' ) {
  ...
  return apply_filters( 'premiumwd_meta_box_post_format_link', array(
    'id'        => 'premiumwd-post-format-link',
 ...
 * @since     2.4.0
 */
function premiumwd_meta_box_post_format_quote( $pages = 'post' ) {
  ...
  return apply_filters( 'premiumwd_meta_box_post_format_quote', array(
    'id'        => 'premiumwd-post-format-quote',
 ...
 * @since     2.4.0
 */
function premiumwd_meta_box_post_format_video( $pages = 'post' ) {
  ...
  return apply_filters( 'premiumwd_meta_box_post_format_video', array(
    'id'        => 'premiumwd-post-format-video',
 ...
 * @since     2.4.0
 */
function premiumwd_meta_box_post_format_audio( $pages = 'post' ) {
  ...
  return apply_filters( 'premiumwd_meta_box_post_format_audio', array(
    'id'        => 'premiumwd-post-format-audio',
 ...
 * @since     2.4.2
 */
if ( ! function_exists( 'premiumwd_get_option_type_by_id' ) ) {

  function premiumwd_get_option_type_by_id( $option_id, $settings_id = '' ) {
    
    if ( empty( $settings_id ) ) {
    
      $settings_id = premiumwd_settings_id();
...
/* End of file premiumwd-functions-admin.php */
/* Location: ./includes/premiumwd-functions-admin.php */