...
function initSlider(){
	$('.owl-nav .owl-prev, .owl-nav .owl-next').html('');
}
function initToCounterHorizontalProgressBar(e) {
    var t = parseFloat(e.find(".progress_content").data("percentage"));
    if (e.find(".progress_number").length) {
        e.find(".progress_number").each(function() {
            $(this).countTo({
                from: 0,
                to: t,
                speed: 1500,
...
function initProgressBars() {
    if ($(".percentage-wrapper.horizontal").length) {
        $(".percentage-wrapper.horizontal").each(function() {
...
function initProgressBarsVertical() {
    if ($(".percentage-wrapper.vertical").length) {
        $(".percentage-wrapper.vertical").each(function() {
            $(this).appear(function() {
