...
if (!class_exists('Premium_Shortcodes')) :
    ...
    class Premium_Shortcodes {
        ...
        function action_frontend_scripts() {
            ...
            $shortcode_css_url = get_template_directory_uri() . '/includes/shortcodes/css/shortcodes.css';
            $shortcode_js_url = get_template_directory_uri() . '/includes/shortcodes/js/shortcodes.js';
            $shortcode_plugins_url = get_template_directory_uri() . '/includes/shortcodes/js/shortcode-plugins.js';
	    
            wp_enqueue_script('jquery-ui-accordion');
	    wp_enqueue_script('jquery-ui-tabs');
            wp_enqueue_style('shortcodes-style', $shortcode_css_url, false, '1.0', 'all');
            wp_enqueue_script('shortcode-plugins-js', $shortcode_plugins_url);
            wp_enqueue_script('shortcodes-js', $shortcode_js_url);
        }
