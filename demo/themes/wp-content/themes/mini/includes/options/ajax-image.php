...
if (!function_exists('premiumwd_ajax_image_upload') || !function_exists('premiumwd_ajax_image_remove')) {
//Save image via AJAX
    add_action('wp_ajax_premiumwd_ajax_upload', 'premiumwd_ajax_image_upload'); //Add support for AJAX save

    function premiumwd_ajax_image_upload() {
...
//Remove image via AJAX
    add_action('wp_ajax_premiumwd_ajax_remove', 'premiumwd_ajax_image_remove'); //Add support for AJAX save

    function premiumwd_ajax_image_remove() {
        global $wpdb; //Now WP database can be accessed
