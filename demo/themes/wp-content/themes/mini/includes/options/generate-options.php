...
if (!class_exists('premiumwd_theme_options')) {
		...
		public function premiumwd_add_menu() {
			add_menu_page(__(THEME_MENU_TITLE), __(THEME_MENU_TITLE), 'administrator', THEME_MENU_SLUG, array(&$this, 'premiumwd_display_page'),  get_template_directory_uri()."/includes/options/" . 'images/icon.png');

			/*add_submenu_page( 'tools.php', 'Support Forums', 'Support Forums', 'manage_options', 'my-custom-submenu-page', 'my_custom_submenu_page_callback' ); */
		}
		...
		public function premiumwd_display_page() { ?>
			...
			<div id="premiumwd-meta-info">
				...
				<h1><?php echo THEME_MENU_TITLE; ?></h1>
		...
		<form id="premiumwd-settings" method="post">
			...
			<div id="premiumwd-content">
					<?php if ( isset ( $_POST['save'] ) ): ?>
							<div class="saved"><p><strong><?php _e( ' Settings have been saved. ' ); ?></strong></p></div>
							    <?php endif; ?>
