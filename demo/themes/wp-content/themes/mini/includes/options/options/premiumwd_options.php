<?php 
	...
	array(
        ...
        "id" => array("premiumwd_shop_addtowishlist"),
        "options" => array(""),
        "desc" => "Choose if you want a add to wishlist icon on products",
        "default" => array("not")),
        ...
        "type" => "checkbox",
        "name" => "Add to Cart",
        "id" => array("premiumwd_shop_addtocart"),
        "options" => array(""),
        "desc" => "Choose if you want a add to cart icon on products",
        "default" => array("not")),
	...
	///////////////////////////////////////	
		...
		"options" => array(""),
        "desc" => "Include search bar in your header menu.",
        "default" => array("checked")),
	...
	"name" => "Pagination",
 	"options" => array("Yes"), //Required
        ...
        "type" => "checkbox",
        "name" => "Sidebar",
        "id" => array("premiumwd_blog_single_sidebar"),
        "options" => array(""),
        "desc" => "Include a Sidebar in your blog single.",
        "default" => array("not")),
       ...
       "placeholder" => "http://example.com/marker.png",
		...
		"type" => "checkbox",
		"name" => "Sticky Footer",
		"id" => array( "premiumwd_footer_sticky" ),        
		"options" => array(""), //Required
        "desc" => "Choose whether you want the menu to be be revealed when scrolled to bottom.",
		"default" => array("not")),
