...
class instagram_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'A widget that displays your Instagram feed.'), )
		);
	}
			...
			<div class="instagram-image-wrapper">
				...
				<ul>
					<li class="instagram_badge_image" id="instagram_badge_image<?php echo $i; ?>">
						<a href="<?php echo $post['../../../../../../../stack/wp-content/themes/stack/includes/widgets/instagram/link']; ?>" target="_blank">
							<img src="<?php echo $post['../../../../../../../stack/wp-content/themes/stack/includes/widgets/instagram/image']; ?>" alt="A post on Instagram" title="<?php echo $post['caption']; ?>">
						</a>
					</li>
				</ul>
				<?php
