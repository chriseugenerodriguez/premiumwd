...
class WDVideo extends WP_Widget {

	/** constructor */
    function __construct()
    {
        parent::__construct( false, 'WD Video', array('description' => 'Display a responsive video by adding a link or embed code.', 'classname' => 'widget_alx_video') );
    }
	/*  Constructor
/* ------------------------------------ */
	function WDVideo() {
