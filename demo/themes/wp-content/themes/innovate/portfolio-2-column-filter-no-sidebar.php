...
<li class="portfolio-item thumb-2-column portfolio-2-column-960 <?php echo strtolower($tax); ?> all">
<div class="thumb-2-column-960 mosaic-block circle">
<a class="mosaic-overlay" href="<?php echo get_permalink(); ?>"></a>
<div class="mosaic-backdrop"><?php the_post_thumbnail('portfolio-2-column-960'); ?></div>
</div>
...
<li class="portfolio-item thumb-2-column portfolio-2-column-1040 <?php echo strtolower($tax); ?> all">
<div class="thumb-2-column-1040 mosaic-block circle">
<a class="mosaic-overlay" href="<?php echo get_permalink(); ?>"></a>
<div class="mosaic-backdrop"><?php the_post_thumbnail('portfolio-2-column-1040'); ?></div>
</div>
<div class="item-description">
<a href="<?php echo get_permalink(); ?>"><h5><?php the_title();?></h5>
<p><?php echo $term->name ?></p></a>
...
<li class="portfolio-item thumb-2-column portfolio-2-column-1120 <?php echo strtolower($tax); ?> all">
<div class="thumb-2-column-1120 mosaic-block circle">
<a class="mosaic-overlay" href="<?php echo get_permalink(); ?>"></a>
<div class="mosaic-backdrop"><?php the_post_thumbnail('portfolio-2-column-1120'); ?></div>
</div>
<div class="item-description">
<a href="<?php echo get_permalink(); ?>"><h5><?php the_title();?></h5>
<p><?php echo $term->name ?></p></a>
