...
class rcp_recent_posts extends WP_Widget {
	...
	function rcp_recent_posts() {
		$widget_ops = array( 'classname' => 'rcp_recent_custom_posts', 'description' => 'Display your recent posts with thumbnail' );
		parent::WP_Widget( 'rcp_recent_custom_posts', $name = 'Premiumwd Recent Posts Widget' );
	}
 ...
 switch($post_formatt){
		...
		case 'video': ?>
        <li class="clearfix"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><?php the_post_thumbnail('recent-thumbnails'); ?></a>
        ...
        <li class="clearfix"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><?php the_post_thumbnail('recent-thumbnails');?></a>
        <a class="title" href="<?php echo get_post_meta(get_the_ID(),'_format_quote_source_url',true);?>" title="<?php echo esc_attr(get_the_title() ? get_the_title() : get_the_ID()); ?>"><?php if ( get_the_title() ) the_title(); else the_ID(); ?></a>
        <p><?php echo get_the_date(); ?></p>
        </li>
        
		<?php break ; case 'link': ?>
        <li class="clearfix"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><?php the_post_thumbnail('recent-thumbnails');?></a>
        <a class="title" href="<?php echo get_post_meta(get_the_ID(),'_format_link_url',true); ?>" title="<?php echo esc_attr(get_the_title() ? get_the_title() : get_the_ID()); ?>"><?php if ( get_the_title() ) the_title(); else the_ID(); ?></a>
        <p><?php echo get_the_date(); ?></p>
        </li>
