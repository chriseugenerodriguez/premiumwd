...
if (!class_exists('premiumwd_theme_options')) {
		...
		public function premiumwd_add_menu() {
			add_menu_page(__(THEME_MENU_TITLE), __(THEME_MENU_TITLE), 'administrator', THEME_MENU_SLUG, array(&$this, 'premiumwd_display_page'),  get_template_directory_uri()."/premiumwd-options/" . 'images/icon.png');
