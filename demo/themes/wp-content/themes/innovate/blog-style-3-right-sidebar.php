<?php /* Template Name: Blog Style 3 Right Sidebar */ ?>
...
<?php $post_formatt = get_post_format();
 switch($post_formatt){
		...
		<div class="blog-3-video"><?php echo get_post_meta(get_the_ID(),'_format_video_embed',true);?></div>
        <h2 class="blog-3-header"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s', 'responsive'), the_title_attribute('echo=0')); ?>"><?php the_title(); ?></a></h2>
        <div class="blog-3-details">
    ...
    <!-- JPLAYER END -->
        ...
        <aside id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
        <div class="mosaic-block circle blog-3-style-thumb">
		...
		<?php break ; case 'link': ?>
        <aside id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
        <h3 class="blog-3-header"><a href="http://<?php echo get_post_meta(get_the_ID(),'_format_link_url',true); ?>"><?php the_title(); ?></a></h3>
        </aside><!-- end of #post-<?php the_ID(); ?> -->
