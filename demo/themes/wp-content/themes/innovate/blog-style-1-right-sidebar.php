<?php /* Template Name: Blog Style 1 Right Sidebar */ ?>
...
<?php $post_formatt = get_post_format();
 switch($post_formatt){
		...
		<div class="blog-1-video"><?php echo get_post_meta(get_the_ID(),'_format_video_embed',true);?></div>
		<div class="date">
        <div class="day"><?php echo get_the_date('d') ?></div>
        <div class="month"><?php echo get_the_date('M') ?></div>
        </div>
	 	<div class="blog-1-details">
		<h2 class="blog-1-header"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s', 'responsive'), the_title_attribute('echo=0')); ?>"><?php the_title(); ?></a></h2>
    ...
    supplied: "mp3"
        ...
        <span><em class="icon-home"></em>In <?php the_category(', '); ?>  </span>
        <span><em class="icon-comment"></em><?php comments_number( 'No Comments', 'One Comment', '% Comments' ); ?></span>        
        </div><!-- end of .blog-meta --><div class="blog-1-excerpt">
              	<p><?php echo excerpt(35); ?></p>
                </div><!-- end of .post-main --> 
                <a class="button black small" href="<?php echo get_permalink( $post->ID ); ?>">Read more</a>
                </div>
		...
		<?php break ; case 'link': ?>
        <aside id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
        <h3 class="blog-1-header"><a href="http://<?php echo get_post_meta(get_the_ID(),'_format_link_url',true); ?>"><?php the_title(); ?></a></h3>
        </aside><!-- end of #post-<?php the_ID(); ?> -->
