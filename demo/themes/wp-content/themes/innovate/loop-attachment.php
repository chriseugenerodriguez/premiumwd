 ...
 <div id="entry-content">
                <div class="entry-content clearfix">
					...
					<div class="entry-meta">
						<?php
							printf( __( '<span class="%1$s">By</span> %2$s', 'innovate' ),
						...
						<?php
							printf( __( '<span class="%1$s">Published</span> %2$s', 'innovate' ),
							...
							if ( wp_attachment_is_image() ) {
								...
								printf( __( 'Full size is %s pixels', 'innovate' ),
									sprintf( '<a href="%1$s" title="%2$s">%3$s &times; %4$s</a>',
										wp_get_attachment_url(),
										esc_attr( __( 'Link to full-size image', 'innovate' ) ),
										$metadata['width'],
										$metadata['height']
									)
								);
						...
						?>
						<?php edit_post_link( __( 'Edit', 'innovate' ), '<span class="meta-sep">|</span> <span class="edit-link">', '</span>' ); ?>
					</div><!-- .entry-meta -->
...
?>
						<p class="attachment"><a href="<?php echo $next_attachment_url; ?>" title="<?php the_title_attribute(); ?>" rel="attachment"><?php
							$attachment_width  = apply_filters( 'innovate_attachment_size', 900 );
							$attachment_height = apply_filters( 'innovate_attachment_height', 900 );
...
<?php wp_link_pages( array( 'before' => '<div class="page-link">' . __( 'Pages:', 'innovate' ), 'after' => '</div>' ) ); ?>
					...
					<div class="entry-utility">
						<?php innovate_posted_in(); ?>
						<?php edit_post_link( __( 'Edit', 'innovate' ), ' <span class="edit-link">', '</span>' ); ?>
					</div><!-- .entry-utility -->
