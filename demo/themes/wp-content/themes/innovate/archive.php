...
<?php if (have_posts()) : ?>
        	...
        	<?php is_category() ?>
		<div id="entry-title"><div class="entry-title"><h1 class="page-title">
			<?php if ( is_day() ) : ?>
				<?php printf( __( 'Daily Archives: <span>%s</span>', 'innovate' ), get_the_date() ); ?>
			<?php elseif ( is_month() ) : ?>
				<?php printf( __( 'Monthly Archives: <span>%s</span>', 'innovate' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'innovate' ) ) ); ?>
			<?php elseif ( is_year() ) : ?>
				<?php printf( __( 'Yearly Archives: <span>%s</span>', 'innovate' ), get_the_date( _x( 'Y', 'yearly archives date format', 'innovate' ) ) ); ?>
			<?php else : ?>
				<?php _e( 'Archives', 'innovate' ); ?>
			<?php endif; ?>
			</h1><?php the_breadcrumb(); ?> </div>
</div>
...
<table width="320" border="0" cellspacing="10" cellpadding="0">
  <tr>
    <td> 
