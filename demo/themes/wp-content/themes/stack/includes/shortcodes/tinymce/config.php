...
$premium_shortcodes['blockquote'] = array(
	...
	'shortcode' => '[blockquote show_quote_icon={{show_quote_icon}} quote_icon_color={{quote_icon_color}} border_color={{border_color}} background_color={{background_color}} line_height={{line_height}} width={{width}} text_color={{text_color}} font_family="{{font_family}}" ] {{content}} [/blockquote]',
...
$premium_shortcodes['icon-list-item'] = array(
	...
	'shortcode' => '[icon_list_item title_size="{{title_size}}" title_color="{{title_color}}" icon_border_color="{{icon_border_color}}" icon_color="{{icon_color}}" icon_type="{{icon_type}}" icon="{{icon}}" title="{{title}}" font_family="{{font_family}}" /]',
...
$premium_shortcodes['icons-text'] = array(
	...
	'shortcode' => '[icon_text box_type="{{box_type}}" box_border_color="{{box_border_color}}" box_background_color="{{box_background_color}}" target="{{target}}" link="{{link}}" link_color="{{link_color}}" link_text="{{link_text}}" icon_type="{{icon_type}}"  target="{{target}}" icon="{{icon}}" icon_size="{{icon_size}}" icon_position="{{icon_position}}" icon_color="{{icon_color}}" icon_background_color="{{icon_background_color}}" title="{{title}}" title_color="{{title_color}}" title_tag="{{title_tag}}" text_color="{{text_color}}" text="{{text}}" font_family /]',
