<?php
	...
	function portfolio_masonry_init() {
		if ( is_home() || is_page_template( 'portfolio.php' ) ) {	
			wp_enqueue_script('jquery-masonry-min', get_template_directory_uri() . '/includes/portfolio/js/isotope.min.js?t=11', array( 'jquery' ) );
		 }
	}
	add_action('wp_footer','portfolio_masonry_init', 1 );
