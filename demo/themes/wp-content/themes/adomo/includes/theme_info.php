...
if(!defined('THEME_NAME')){
    ...
    define('THEME_MENU_TITLE', 'Adomo'); //Define your menu title
    define('THEME_MENU_SLUG', 'premiumwd_theme_options'); //Define your menu slug
    define('THEME_DOMAIN', 'Adomo');
    define('THEME_PRODUCT_ID', 'Adomo');
	...
	<div id="premiumwd-meta-info">
	   <div id="premiumwd-meta">
		  ...
		  <ul class="theme-links">
			 <li><a class="forums" href="http://www.premiumwd.com/support" target="_blank">Support Forums</a></li>
	...
	<form id="premiumwd-settings" method="post" action="">
	   <div id="premiumwd-sidebar">
		  <ul id="premiumwd-main-menu">
			 <li>
				<p><span class="premiumwd-fa fa-general"></span> Activate Theme</p>
			 </li>
		  </ul>
	   </div>
...
//			include TEMPLATEPATH. '/premiumwd-options/premiumwd_options.php';
    ...
    <p>' . __('Adomo Theme is currently not activated', THEME_DOMAIN) . '
