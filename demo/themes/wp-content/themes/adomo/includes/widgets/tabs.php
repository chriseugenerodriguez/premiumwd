...
class WDTabs extends WP_Widget {

/*  Constructor
/* ------------------------------------ */
	function WDTabs() {
		parent::__construct( false, 'WD Tabs', array('description' => 'List posts, comments, and/or tags with or without tabs.', 'classname' => 'widget_alx_tabs') );;	
	}
...
/* ------------------------------------ */
	private function _create_tabs($tabs,$count) {
		...
		$titles = array(
			'recent'	=> __('Recent Posts','adomo'),
			'popular'	=> __('Popular Posts','adomo'),
			'comments'	=> __('Recent Comments','adomo'),
			'tags'		=> __('Tags','adomo')
		);
		$icons = array(
				...
				<li>
					...
					<div class="tab-item-thumbnail">
						<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
							...
							<?php if ( has_post_format('audio') && !is_sticky() ) echo'<span class="thumb-icon small"><i class="fa fa-headphones"></i></span>'; ?>
			...
			<ul id="tab-comments" class="alx-tab group <?php if($instance['comments_avatars']) { echo 'avatars-enabled'; } ?>">
				...
				<li>
						...
						<div class="tab-item-inner group">
							...
							<div class="tab-item-name"><?php echo $comment->comment_author; ?> <?php _e('says:','adomo'); ?></div>
