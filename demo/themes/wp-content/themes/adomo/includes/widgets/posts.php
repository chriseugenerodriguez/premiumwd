...
class WDPosts extends WP_Widget {

/*  Constructor
/* ------------------------------------ */
	function WDPosts() {
		parent::__construct( false, 'WD Posts', array('description' => 'Display posts from a category', 'classname' => 'widget_alx_posts') );;	
	}
		...
		<li>
			...
			<div class="post-item-thumbnail">
				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
					...
					<?php if ( has_post_format('audio') && !is_sticky() ) echo'<span class="thumb-icon"><i class="fa fa-headphones"></i></span>'; ?>
