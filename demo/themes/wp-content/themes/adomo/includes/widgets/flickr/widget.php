...
<div id="fbw-<?php echo $this->id ; ?>" class="totalControls tabbable tabs-left">
  ...
  <ul class="tab-content">
    <li class="tab-pane <?php if ( $instance['tab'][0] ) : ?>active<?php endif; ?>">
      <ul>
        <li>
          ...
          <?php _e( 'Give the widget title, or leave it empty for no title.', $this->textdomain ); ?>
          </span>
        ...
        <li>
          ...
          <span class="controlDesc">
          <?php _e( 'The type of images from user or group.', $this->textdomain ); ?>
          </span>
        ...
        <li>
          <label for="<?php echo $this->get_field_id('flickr_id'); ?>">
            <?php _e('Flickr ID', $this->textdomain); ?>
          </label>
          ...
          <span class="controlDesc">
          <?php _e( 'Put the flickr ID here, go to <a href="http://goo.gl/PM6rZ" target="_blank">Flickr NSID Lookup</a> if you don\'t know your ID. Example: 71865026@N00', $this->textdomain ); ?>
          </span> </li>
        <li>
          <label for="<?php echo $this->get_field_id('count'); ?>">
            <?php _e('Number', $this->textdomain); ?>
          </label>
          <span class="controlDesc">
          <?php _e( 'Number of images shown from 1 to 10', $this->textdomain ); ?>
          </span>
        ...
        <li>
          <label for="<?php echo $this->get_field_id('display'); ?>">
            <?php _e('Display Method', $this->textdomain); ?>
          </label>
          <span class="controlDesc">
          <?php _e( 'Get the image from recent or use random function.', $this->textdomain ); ?>
          </span>
        ...
        <li>
          <label for="<?php echo $this->get_field_id('sizes'); ?>">
            <?php _e( 'Sizes', $this->textdomain ); ?>
          </label>
          <span class="controlDesc">
          <?php _e( 'Represents the size of the image', $this->textdomain ); ?>
          </span>
        ...
        <li>
          <label for="<?php echo $this->get_field_id( 'copyright' ); ?>">
            <input class="checkbox" type="checkbox" <?php checked( $instance['copyright'], true ); ?> id="<?php echo $this->get_field_id( 'copyright' ); ?>" name="<?php echo $this->get_field_name( 'copyright' ); ?>" />
            <?php _e( 'Show Copyright', $this->textdomain ); ?>
          </label>
          <span class="controlDesc">
          <?php _e( 'Display the plugin name with link in the front end.', $this->textdomain ); ?>
          </span> </li>
      </ul>
    </li>
    <li class="tab-pane <?php if ( $instance['tab'][1] ) : ?>active<?php endif; ?>">
      <ul>
        <li>
          <label for="<?php echo $this->get_field_id('intro_text'); ?>">
            <?php _e( 'Intro Text', $this->textdomain ); ?>
          </label>
          <span class="controlDesc">
          <?php _e( 'This option will display addtional text before the widget content and HTML supports.', $this->textdomain ); ?>
          </span>
        ...
        <li>
          <label for="<?php echo $this->get_field_id('outro_text'); ?>">
            <?php _e( 'Outro Text', $this->textdomain ); ?>
          </label>
          <span class="controlDesc">
          <?php _e( 'This option will display addtional text after widget and HTML supports.', $this->textdomain ); ?>
          </span>
        ...
        <li>
          <label for="<?php echo $this->get_field_id('custom'); ?>">
            <?php _e( 'Custom Script & Stylesheet', $this->textdomain ) ; ?>
          </label>
          <span class="controlDesc">
          <?php _e( 'Use this box for additional widget CSS style of custom javascript. Current widget selector: ', $this->textdomain ); ?>
          <?php echo '<tt>#' . $this->id . '</tt>'; ?></span>
