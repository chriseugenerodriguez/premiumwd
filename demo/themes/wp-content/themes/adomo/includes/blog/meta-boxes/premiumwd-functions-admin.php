...
if ( ! function_exists( 'premiumwd_admin_styles' ) ) {
  ...
  function premiumwd_admin_styles() {
    ...
    /* load admin styles */
    wp_enqueue_style( 'premiumwd-admin-css', get_template_directory_uri().'/includes/meta-boxes/assets/css/premiumwd-admin.css', false, '1.0.0' );
...
if ( ! function_exists( 'premiumwd_admin_scripts' ) ) {
  ...
  function premiumwd_admin_scripts() {
    ...
    wp_enqueue_script( 'jquery-ui-timepicker',  get_template_directory_uri().'/includes/meta-boxes/assets/js/vendor/jquery/jquery-ui-timepicker.js', array( 'jquery', 'jquery-ui-slider', 'jquery-ui-datepicker' ), '1.4.3' );
    
    /* load all the required scripts */
    wp_enqueue_script( 'premiumwd-admin-js',  get_template_directory_uri().'/includes/meta-boxes/assets/js/premiumwd-admin.js', array( 'jquery', 'jquery-ui-tabs', 'jquery-ui-sortable', 'jquery-ui-slider', 'wp-color-picker', 'jquery-ui-datepicker', 'jquery-ui-timepicker' ), '1.0.0');
