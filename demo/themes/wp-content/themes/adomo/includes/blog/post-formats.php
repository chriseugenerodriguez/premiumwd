...
<div class="post-format">
  <div class="format-container group pad">
    <blockquote> <?php echo (isset($meta['_chat'][0])?wpautop($meta['_chat'][0]):''); ?> </blockquote>
  </div>
</div>
<?php endif; ?>
...
<div class="post-format">
  <div class="format-container pad">
    <p><a href="<?php echo (isset($meta['_link_url'][0])?$meta['_link_url'][0]:'#'); ?>"> <?php echo (isset($meta['_link_title'][0])?$meta['_link_title'][0]:get_the_title()); ?> <i class="fa fa-external-link"></i> </a></p>
  </div>
</div>
<?php endif; ?>
