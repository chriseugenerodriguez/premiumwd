 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_display_by_type' ) ) {

  function premiumwd_display_by_type( $args = array() ) {
    
    /* allow filters to be executed on the array */
    $args = apply_filters( 'premiumwd_display_by_type', $args );
    
    /* build the function name */
    $function_name_by_type = str_replace( '-', '_', 'premiumwd_type_' . $args['type'] );
 ...
 *
 * See @premiumwd_display_by_type to see the full list of available arguments.
 *
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_background' ) ) {
  
  function premiumwd_type_background( $args = array() ) {
    ...
    echo '<div class="format-setting type-background ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        $premiumwd_recognized_background_fields = apply_filters( 'premiumwd_recognized_background_fields', array( 
          'background-color',
          'background-repeat', 
        ...
        echo '<div class="premiumwd-background-group">';
        
          /* build background color */
          if ( in_array( 'background-color', $premiumwd_recognized_background_fields ) ) {
          
            echo '<div class="option-tree-ui-colorpicker-input-wrap">';
              
              /* colorpicker JS */      
              echo '<script>jQuery(document).ready(function($) { Premiumwd_UI.bind_colorpicker("' . esc_attr( $field_id ) . '-picker"); });</script>';
          ...
          if ( in_array( 'background-repeat', $premiumwd_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-repeat]" id="' . esc_attr( $field_id ) . '-repeat" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              foreach ( premiumwd_recognized_background_repeat( $field_id ) as $key => $value ) {
          ...
          if ( in_array( 'background-attachment', $premiumwd_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-attachment]" id="' . esc_attr( $field_id ) . '-attachment" class="option-tree-ui-select ' . $field_class . '">';
              ...
              foreach ( premiumwd_recognized_background_attachment( $field_id ) as $key => $value ) {
          ...
          if ( in_array( 'background-position', $premiumwd_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-position]" id="' . esc_attr( $field_id ) . '-position" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              foreach ( premiumwd_recognized_background_position( $field_id ) as $key => $value ) {
          ...
          if ( in_array( 'background-size', $premiumwd_recognized_background_fields ) ) {
             ...
             *
             */
            $choices = apply_filters( 'premiumwd_type_background_size_choices', '', $field_id );
            ...
            if ( is_array( $choices ) && ! empty( $choices ) ) {
              ...
              echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-size]" id="' . esc_attr( $field_id ) . '-size" value="' . ( isset( $field_value['background-size'] ) ? esc_attr( $field_value['background-size'] ) : '' ) . '" class="widefat premiumwd-background-size-input option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'background-size', 'option-tree' ) . '" />';
        ...
        if ( in_array( 'background-image', $premiumwd_recognized_background_fields ) ) {
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* add media button */
            echo '<a href="javascript:void(0);" class="premiumwd_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . __( 'Add Media', 'option-tree' ) . '"><span class="icon premiumwd-icon-plus-circle"></span>' . __( 'Add Media', 'option-tree' ) . '</a>';
          ...
          if ( isset( $field_value['background-image'] ) && $field_value['background-image'] !== '' ) {
            ...
            echo '<div class="option-tree-ui-media-wrap" id="' . esc_attr( $field_id ) . '_media">';
              ...
              echo '<a href="javascript:(void);" class="option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="' . __( 'Remove Media', 'option-tree' ) . '"><span class="icon premiumwd-icon-minus-circle"></span>' . __( 'Remove Media', 'option-tree' ) . '</a>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_category_checkbox' ) ) {
  
  function premiumwd_type_category_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-category-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* get category array */
        $categories = get_categories( apply_filters( 'premiumwd_type_category_checkbox_query', array( 'hide_empty' => false ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_category_select' ) ) {
  
  function premiumwd_type_category_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-category-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* get category array */
        $categories = get_categories( apply_filters( 'premiumwd_type_category_select_query', array( 'hide_empty' => false ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_checkbox' ) ) {
  
  function premiumwd_type_checkbox( $args = array() ) {
 ...
 * @updated   2.2.0
 */
if ( ! function_exists( 'premiumwd_type_colorpicker' ) ) {
  
  function premiumwd_type_colorpicker( $args = array() ) {
    ...
    echo '<div class="format-setting type-colorpicker ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        echo '<div class="option-tree-ui-colorpicker-input-wrap">';
          ...
          /* colorpicker JS */      
          echo '<script>jQuery(document).ready(function($) { Premiumwd_UI.bind_colorpicker("' . esc_attr( $field_id ) . '"); });</script>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_css' ) ) {
  
  function premiumwd_type_css( $args = array() ) {
    ...
    echo '<div class="format-setting type-css simple ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        echo '<pre class="premiumwd-css-editor ' . esc_attr( $field_class ) . '" id="' . esc_attr( $field_id ) . '">' . esc_textarea( $field_value ) . '</pre>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_custom_post_type_checkbox' ) ) {
  
  function premiumwd_type_custom_post_type_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-custom-post-type-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'premiumwd_type_custom_post_type_checkbox_query', array( 'post_type' => $post_type, 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_custom_post_type_select' ) ) {
  
  function premiumwd_type_custom_post_type_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-custom-post-type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'premiumwd_type_custom_post_type_select_query', array( 'post_type' => $post_type, 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.3
 */
if ( ! function_exists( 'premiumwd_type_date_picker' ) ) {
  
  function premiumwd_type_date_picker( $args = array() ) {
    ...
    /* filter date format */
    $date_format = apply_filters( 'premiumwd_type_date_picker_date_format', 'yy-mm-dd', $field_id );
    
    /* format setting outer wrapper */
    echo '<div class="format-setting type-date-picker ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
    
    /* date picker JS */      
    echo '<script>jQuery(document).ready(function($) { Premiumwd_UI.bind_date_picker("' . esc_attr( $field_id ) . '", "' . esc_attr( $date_format ) . '"); });</script>';      
 ...
 * @since     2.3
 */
if ( ! function_exists( 'premiumwd_type_date_time_picker' ) ) {
  
  function premiumwd_type_date_time_picker( $args = array() ) {
    ...
    /* filter date format */
    $date_format = apply_filters( 'premiumwd_type_date_time_picker_date_format', 'yy-mm-dd', $field_id );
    
    /* format setting outer wrapper */
    echo '<div class="format-setting type-date-time-picker ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
    
    /* date time picker JS */      
    echo '<script>jQuery(document).ready(function($) { Premiumwd_UI.bind_date_time_picker("' . esc_attr( $field_id ) . '", "' . esc_attr( $date_format ) . '"); });</script>';      
 ...
 * @since     2.2.0
 */
if ( ! function_exists( 'premiumwd_type_gallery' ) ) {

  function premiumwd_type_gallery( $args = array() ) {
    ...
    echo '<div class="format-setting type-gallery ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        // Saved values
        echo '<input type="hidden" name="' . esc_attr( $field_name ) . '" id="' . esc_attr( $field_id ) . '" value="' . esc_attr( $field_value ) . '" class="premiumwd-gallery-value ' . esc_attr( $field_class ) . '" />';
        ...
        if ( ! empty( $ids ) ) {
          ...
          echo '<ul class="premiumwd-gallery-list">';
          ...
          echo '
          <div class="premiumwd-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-secondary hug-left premiumwd-gallery-delete">' . __( 'Delete Gallery', 'option-tree' ) . '</a>
            <a href="#" class="option-tree-ui-button button button-primary right hug-right premiumwd-gallery-edit">' . __( 'Edit Gallery', 'option-tree' ) . '</a>
          </div>';
          ...
          echo '
          <div class="premiumwd-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-primary right hug-right premiumwd-gallery-edit">' . __( 'Create Gallery', 'option-tree' ) . '</a>
          </div>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_list_item' ) ) {
  
  function premiumwd_type_list_item( $args = array() ) {
    ...
    echo '<div class="format-setting type-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        echo '<input type="hidden" name="' . esc_attr( $field_id ) . '_settings_array" id="' . esc_attr( $field_id ) . '_settings_array" value="' . premiumwd_encode( serialize( $field_settings ) ) . '" />';
        ...
        if ( is_array( $field_value ) && ! empty( $field_value ) ) {
          ...
          foreach( $field_value as $key => $list_item ) {
            ...
            echo '<li class="ui-state-default list-list-item">';
              premiumwd_list_item_view( $field_id, $key, $list_item, $post_id, $get_option, $field_settings, $type );
            echo '</li>';
        ...
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'premiumwd_list_item_description', __( 'You can re-order with drag & drop, the order will update after saving.', 'option-tree' ), $field_id ) . '</div>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_measurement' ) ) {
  
  function premiumwd_type_measurement( $args = array() ) {
    ...
    echo '<div class="format-setting type-measurement ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        echo '<select name="' . esc_attr( $field_name ) . '[1]" id="' . esc_attr( $field_id ) . '-1" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
          ...
          foreach ( premiumwd_measurement_unit_types( $field_id ) as $unit ) {
 ...
 * @since     2.1
 */
if ( ! function_exists( 'premiumwd_type_numeric_slider' ) ) {

  function premiumwd_type_numeric_slider( $args = array() ) {
    ...
    echo '<div class="format-setting type-numeric-slider ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        echo '<div class="premiumwd-numeric-slider-wrap">';

          echo '<input type="hidden" name="' . esc_attr( $field_name ) . '" id="' . esc_attr( $field_id ) . '" class="premiumwd-numeric-slider-hidden-input" value="' . esc_attr( $field_value ) . '" data-min="' . esc_attr( $min ) . '" data-max="' . esc_attr( $max ) . '" data-step="' . esc_attr( $step ) . '">';

          echo '<input type="text" class="premiumwd-numeric-slider-helper-input widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" value="' . esc_attr( $field_value ) . '" readonly>';

          echo '<div id="premiumwd_numeric_slider_' . esc_attr( $field_id ) . '" class="premiumwd-numeric-slider"></div>';
 ...
 * @since     2.2.0
 */
if ( ! function_exists( 'premiumwd_type_on_off' ) ) {
  
  function premiumwd_type_on_off( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_page_checkbox' ) ) {
  
  function premiumwd_type_page_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-page-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      /* query pages array */
      $my_posts = get_posts( apply_filters( 'premiumwd_type_page_checkbox_query', array( 'post_type' => array( 'page' ), 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_page_select' ) ) {
  
  function premiumwd_type_page_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-page-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query pages array */
        $my_posts = get_posts( apply_filters( 'premiumwd_type_page_select_query', array( 'post_type' => array( 'page' ), 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_post_checkbox' ) ) {
  
  function premiumwd_type_post_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-post-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'premiumwd_type_post_checkbox_query', array( 'post_type' => array( 'post' ), 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_post_select' ) ) {
  
  function premiumwd_type_post_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-post-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'premiumwd_type_post_select_query', array( 'post_type' => array( 'post' ), 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_radio' ) ) {
  
  function premiumwd_type_radio( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_radio_image' ) ) {
  
  function premiumwd_type_radio_image( $args = array() ) {
    ...
    echo '<div class="format-setting type-radio-image ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( empty( $field_choices ) )
          $field_choices = premiumwd_radio_images( $field_id );
          
        /* build radio image */
        foreach ( (array) $field_choices as $key => $choice ) {
          
          $src = str_replace( 'Premiumwd_URL', Premiumwd_URL, $choice['src'] );
          $src = str_replace( 'Premiumwd_THEME_URL', Premiumwd_THEME_URL, $src );
          
          /* make radio image source filterable */
          $src = apply_filters( 'premiumwd_type_radio_image_src', $src, $field_id );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_select' ) ) {
  
  function premiumwd_type_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      $field_choices = apply_filters( 'premiumwd_type_select_choices', $field_choices, $field_id );
 ...
 * to use on a specific area. By using the two provided filters, 'premiumwd_recognized_sidebars', 
 * and 'premiumwd_recognized_sidebars_{$field_id}' we can be selective about which sidebars are 
 ...
 * @since     2.1
 */
if ( ! function_exists( 'premiumwd_type_sidebar_select' ) ) {
  
  function premiumwd_type_sidebar_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-sidebar-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $sidebars = apply_filters( 'premiumwd_recognized_sidebars', $sidebars );
        $sidebars = apply_filters( 'premiumwd_recognized_sidebars_' . $field_id, $sidebars );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_slider' ) ) {
  
  function premiumwd_type_slider( $args = array() ) {
 ...
 * @since     2.4.0
 */
if ( ! function_exists( 'premiumwd_type_social_links' ) ) {
  
  function premiumwd_type_social_links( $args = array() ) {
    
    /* turns arguments array into variables */
    extract( $args );
    
    /* Load the default social links */
    if ( empty( $field_value ) && apply_filters( 'premiumwd_type_social_links_load_defaults', true, $field_id ) ) {
      
      $field_value = apply_filters( 'premiumwd_type_social_links_defaults', array(
        array(
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $field_value ) && ! empty( $field_value ) ) {
          ...
          foreach( $field_value as $key => $link ) {
            ...
            echo '<li class="ui-state-default list-list-item">';
              premiumwd_social_links_view( $field_id, $key, $link, $post_id, $get_option, $field_settings, $type );
            echo '</li>';
        ...
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'premiumwd_social_links_description', __( 'You can re-order with drag & drop, the order will update after saving.', 'option-tree' ), $field_id ) . '</div>';
 ...
 * @since     2.3.0
 */
if ( ! function_exists( 'premiumwd_type_tab' ) ) {
  
  function premiumwd_type_tab( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_tag_checkbox' ) ) {
  
  function premiumwd_type_tag_checkbox( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_tag_select' ) ) {
  
  function premiumwd_type_tag_select( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_taxonomy_checkbox' ) ) {
  
  function premiumwd_type_taxonomy_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-taxonomy-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* get taxonomies */
        $taxonomies = get_categories( apply_filters( 'premiumwd_type_taxonomy_checkbox_query', array( 'hide_empty' => false, 'taxonomy' => $taxonomy ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_taxonomy_select' ) ) {
  
  function premiumwd_type_taxonomy_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* get taxonomies */
        $taxonomies = get_categories( apply_filters( 'premiumwd_type_taxonomy_select_query', array( 'hide_empty' => false, 'taxonomy' => $taxonomy ), $field_id ) );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_text' ) ) {
  
  function premiumwd_type_text( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_textarea' ) ) {
  
  function premiumwd_type_textarea( $args = array() ) {
      ...
      echo '<div class="format-setting-inner">';
        ...
        wp_editor( 
          ...
          array(
            ...
            'wpautop'       => apply_filters( 'premiumwd_wpautop', false, $field_id ),
            'media_buttons' => apply_filters( 'premiumwd_media_buttons', true, $field_id ),
            'textarea_name' => esc_attr( $field_name ),
            'textarea_rows' => esc_attr( $field_rows ),
            'tinymce'       => apply_filters( 'premiumwd_tinymce', true, $field_id ),              
            'quicktags'     => apply_filters( 'premiumwd_quicktags', array( 'buttons' => 'strong,em,link,block,del,ins,img,ul,ol,li,code,spell,close' ), $field_id )
          ) 
        );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_textarea_simple' ) ) {
  
  function premiumwd_type_textarea_simple( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_textblock' ) ) {
  
  function premiumwd_type_textblock( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_textblock_titled' ) ) {
  
  function premiumwd_type_textblock_titled( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_typography' ) ) {
  
  function premiumwd_type_typography( $args = array() ) {
    ...
    echo '<div class="format-setting type-typography ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        /* allow fields to be filtered */
        $premiumwd_recognized_typography_fields = apply_filters( 'premiumwd_recognized_typography_fields', array( 
          'font-color',
          'font-family', 
          'font-size', 
          'font-style', 
        ...
        /* build font color */
        if ( in_array( 'font-color', $premiumwd_recognized_typography_fields ) ) {
        ...
        /* build font family */
        if ( in_array( 'font-family', $premiumwd_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[font-family]" id="' . esc_attr( $field_id ) . '-font-family" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( premiumwd_recognized_font_families( $field_id ) as $key => $value ) {
        ...
        /* build font size */
        if ( in_array( 'font-size', $premiumwd_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[font-size]" id="' . esc_attr( $field_id ) . '-font-size" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach( premiumwd_recognized_font_sizes( $field_id ) as $option ) { 
        ...
        /* build font style */
        if ( in_array( 'font-style', $premiumwd_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[font-style]" id="' . esc_attr( $field_id ) . '-font-style" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( premiumwd_recognized_font_styles( $field_id ) as $key => $value ) {
        ...
        /* build font variant */
        if ( in_array( 'font-variant', $premiumwd_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[font-variant]" id="' . esc_attr( $field_id ) . '-font-variant" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( premiumwd_recognized_font_variants( $field_id ) as $key => $value ) {
        ...
        /* build font weight */
        if ( in_array( 'font-weight', $premiumwd_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[font-weight]" id="' . esc_attr( $field_id ) . '-font-weight" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( premiumwd_recognized_font_weights( $field_id ) as $key => $value ) {
        ...
        if ( in_array( 'letter-spacing', $premiumwd_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[letter-spacing]" id="' . esc_attr( $field_id ) . '-letter-spacing" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach( premiumwd_recognized_letter_spacing( $field_id ) as $option ) { 
        ...
        /* build line height */
        if ( in_array( 'line-height', $premiumwd_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[line-height]" id="' . esc_attr( $field_id ) . '-line-height" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach( premiumwd_recognized_line_heights( $field_id ) as $option ) { 
        ...
        if ( in_array( 'text-decoration', $premiumwd_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[text-decoration]" id="' . esc_attr( $field_id ) . '-text-decoration" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( premiumwd_recognized_text_decorations( $field_id ) as $key => $value ) {
        ...
        if ( in_array( 'text-transform', $premiumwd_recognized_typography_fields ) ) {
          ...
          echo '<select name="' . esc_attr( $field_name ) . '[text-transform]" id="' . esc_attr( $field_id ) . '-text-transform" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
            ...
            foreach ( premiumwd_recognized_text_transformations( $field_id ) as $key => $value ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'premiumwd_type_upload' ) ) {
  
  function premiumwd_type_upload( $args = array() ) {
...
/* End of file premiumwd-functions-option-types.php */
/* Location: ./includes/premiumwd-functions-option-types.php */