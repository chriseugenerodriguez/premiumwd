...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
      array(
        ...
        'desc'        => sprintf( __( 'The Background option type is for adding background styles to your theme either dynamically via the CSS option type below or manually with %s. The Background option type has filters that allow you to remove fields or change the defaults. For example, you can filter %s to remove unwanted fields from all Background options or an individual one. You can also filter %s. These filters allow you to fine tune the select lists for your specific needs.', 'theme-text-domain' ), '<code>premiumwd_get_option()</code>', '<code>premiumwd_recognized_background_fields</code>', '<code>premiumwd_recognized_background_repeat</code>, <code>premiumwd_recognized_background_attachment</code>, <code>premiumwd_recognized_background_position</code>, ' . __( 'and', 'theme-text-domain' ) . ' <code>premiumwd_type_background_size_choices</code>' ),
        'std'         => '',
        'type'        => 'background',
  ...
  {{demo_background}}
      ...
      array(
        ...
        'desc'        => sprintf( __( 'The Gallery option type can also be saved as a shortcode by adding %s to the class attribute. Using the Gallery option type in this manner will result in a better user experience as you\'re able to save the link, column, and order settings.', 'theme-text-domain' ), '<code>premiumwd-gallery-shortcode</code>' ),
        'std'         => '',
        'type'        => 'gallery',
        'section'     => 'option_types',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => sprintf( __( 'the Radio Images option type is primarily used for layouts. However, you can filter the image list using %s. As well, you can add your own custom images using the choices array.', 'theme-text-domain' ), '<code>premiumwd_radio_images</code>' ),
        'std'         => 'right-sidebar',
        'type'        => 'radio-image',
        'section'     => 'option_types',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => sprintf( __( 'The Typography option type is for adding typography styles to your theme either dynamically via the CSS option type above or manually with %s. The Typography option type has filters that allow you to remove fields or change the defaults. For example, you can filter %s to remove unwanted fields from all Background options or an individual one. You can also filter %s. These filters allow you to fine tune the select lists for your specific needs.', 'theme-text-domain' ), '<code>premiumwd_get_option()</code>', '<code>premiumwd_recognized_typography_fields</code>', '<code>premiumwd_recognized_font_families</code>, <code>premiumwd_recognized_font_sizes</code>, <code>premiumwd_recognized_font_styles</code>, <code>premiumwd_recognized_font_variants</code>, <code>premiumwd_recognized_font_weights</code>, <code>premiumwd_recognized_letter_spacing</code>, <code>premiumwd_recognized_line_heights</code>, <code>premiumwd_recognized_text_decorations</code> ' . __( 'and', 'theme-text-domain' ) . ' <code>premiumwd_recognized_text_transformations</code>' ),
        'std'         => '',
        'type'        => 'typography',
        'section'     => 'option_types',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => sprintf( __( 'The Upload option type can also be saved as an attachment ID by adding %s to the class attribute.', 'theme-text-domain' ), '<code>premiumwd-upload-attachment-id</code>' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'option_types',
        'rows'        => '',
        ...
        'taxonomy'    => '',
        'min_max_step'=> '',
        'class'       => 'premiumwd-upload-attachment-id',
        'condition'   => '',
        'operator'    => 'and'
      )
    )
