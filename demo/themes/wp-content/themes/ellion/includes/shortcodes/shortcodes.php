...
if (!class_exists('Premium_Shortcodes')) :
    ...
    class Premium_Shortcodes {
        ...
        function __construct() {
            ...
            add_action('wp_footer', array(&$this, 'action_frontend_scripts'), 1);
            add_action('wp_enqueue_scripts', array(&$this, 'action_frontend_styles'), 1);
        }
	function action_frontend_styles() {
	   $theme_css_url = get_template_directory_uri() . '/includes/shortcodes/css/shortcodes.css?t=1';
