...
// REGISTER WIDGET
add_action( 'widgets_init', 'init_instagram_widget' );
function init_instagram_widget() { return register_widget('instagram_widget'); }
...
class instagram_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'WD Instagram Widget', // NAME
			array( 'description' => __( 'A widget that ellions your Instagram feed.', 'ellion'), )
		);
	}
	...
	public function widget($args, $instance) {
		...
		if (!empty($ip_instagram_plugin_posts)) {
			...
			<div class="instagram-image-wrapper">
				...
				?>
				<ul>
					<li class="instagram_badge_image" id="instagram_badge_image<?php echo $i; ?>">
	...
	public function form($instance) {
		$defaults = array( 'title' => 'Instagram Plugin',
						   'clientid' => '',
						   'clientsecret' => '',
						   'cachetime' => '5',
						   'show' => 'recent'
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'ellion' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $instance['title'] ); ?>" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'clientid' ); ?>"><?php _e( 'Client ID:', 'ellion' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'clientsecret' ); ?>"><?php _e( 'Client Secret:', 'ellion' ); ?></label>
		...
		<p>
			<label><?php _e( 'Access Token: ', 'ellion' ); ?></label>
			<?php
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show' ); ?>"><?php _e('Show:', 'ellion'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'cachetime' ); ?>"><?php _e( 'Cache every:', 'ellion' ); ?></label>
     ...
     if ( 'post' == strtolower( $_SERVER['REQUEST_METHOD'] ) ) {
          ...
          if ( isset( $_POST['delete_widget'] ) ) {
               if ( 1 === (int) $_POST['delete_widget'] ) {
                    if ( strpos($widget_id, 'instagram') !== FALSE ) {
